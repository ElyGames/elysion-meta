...
SWEP.PrintName				= "King Cobra Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("KingCobra.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 195					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 195					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPName				= "Pocket AWP"
SWEP.NZPaPReplacement 	= "tfa_cso_kingcobra_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 42				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.325					-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.18					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.165				-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadIncrement = 4 --What percentage of the modifier is added on, per shot.
SWEP.Primary.SpreadRecovery = 4.0 --How much the spread recovers, per second.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_kingcobra_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_kingcobra_v6.mdl" -- same case UHGI;DFSD/
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/kingcobra/kingcobra_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(6.965, -7.764, 1.746)
SWEP.IronSightsAng = Vector(0, 7.961, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_kingcobra_v6")
