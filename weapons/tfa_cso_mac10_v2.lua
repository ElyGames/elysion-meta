...
--Firing related
SWEP.Primary.Sound 			= Sound("MAC10.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mac10_v2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mac10.mdl" -- Worldmodel path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mac10_v2")
