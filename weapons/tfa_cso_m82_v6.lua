...
SWEP.PrintName				= "Parker Hale M82 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M82.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 45					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Ear Destroyer"
SWEP.NZPaPReplacement 	= "tfa_cso_m82_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.375				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.375					-- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.Spread		= .0225			--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.JumpAccuracyMultiplier=4--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m82_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m82_v6.mdl" -- Worldmodel path
...
--[[SCOPES]]--
SWEP.IronSightsSensitivity = 1 --Useful for a RT scope.  Change this to 0.25 for 25% sensitivity
...
SWEP.BoltTimerOffset = 0.10 --How long you stay sighted in after shooting, with a bolt action.
...
SWEP.IronSightsPos = Vector(7.8, -6.031, -1.005)
SWEP.IronSightsAng = Vector(26, 20.402, 18.291)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m82_v6")
