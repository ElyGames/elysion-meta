...
if TFA and TFA.AddSound then
	...
	TFA.AddSound(p2.."Eqiup", CHAN_STATIC, 1, 140, 100, p1.."knife_bayonet_equip.ogg", ")")
	TFA.AddSound(p2.."Hit_Wall", CHAN_STATIC, 1, 140, 100, p1.."knife_bayonet_hit_wall.ogg", ")")
	TFA.AddSound(p2.."Hit", CHAN_STATIC, 1, 140, 100, {p1.."knife_bayonet_hit1.ogg",p1.."knife_bayonet_hit2.ogg"}, ")")
	TFA.AddSound(p2.."Holster", CHAN_STATIC, 1, 140, 100, p1.."knife_bayonet_holster.ogg", ")")
	TFA.AddSound(p2.."Stab", CHAN_STATIC, 1, 140, 100, p1.."knife_bayonet_stab.ogg", ")")
	TFA.AddSound(p2.."Swing", CHAN_STATIC, 1, 140, 100, {p1.."knife_bayonet_swing1.ogg",p1.."knife_bayonet_swing2.ogg"}, ")")
end
