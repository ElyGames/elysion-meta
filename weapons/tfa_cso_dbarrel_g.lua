...
SWEP.PrintName				= "Double-barreled shotgun Gold Edition"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Dbarrel.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Doubt shotgun"
SWEP.NZPaPReplacement 	= "tfa_cso_tbarrel"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dbarrelg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dbarrel_g.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dbarrel_g")
