...
SWEP.PrintName				= "AA12 Gold"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]-- 
SWEP.Primary.Sound = Sound("KF_AA12") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("KF_AA12")-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("KF_AA12"), -- Indoor
	[256] = Sound("KF_AA12") -- Outdoor
} 
...
SWEP.Primary.RPM = 1500 -- This is in Rounds Per Minute / RPM
SWEP.Primary.BurstDelay = nil -- Delay between bursts, leave nil to autocalculate
SWEP.Primary.DryFireDelay = 0.2
...
--Firing Cone Related 
SWEP.Primary.Spread = 0.065 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = 0.035  -- Ironsight accuracy, should be the same for shotguns
...
SWEP.MuzzleFlashEffect = "NMRIH_SHOTGUN_FLASH"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/KF/v_g_12.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 60		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(-.5,-2, 2.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
