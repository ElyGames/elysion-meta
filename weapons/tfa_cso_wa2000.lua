...
SWEP.PrintName				= "Walther WA2000"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 96					-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "The Blast Falcon"
SWEP.NZPaPReplacement 	= "tfa_cso_wa2000_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.StaticRecoilFactor = 0.20 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_wa2000.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_wa2000.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_wa2000")
