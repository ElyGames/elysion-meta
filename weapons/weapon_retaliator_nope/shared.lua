SWEP.Gun					= ("weapon_retaliator_nope") --Make sure this is unique.  Specically, your folder name.
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_bash_base"
SWEP.Category				= "Nopeful's Randoms" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = nil --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Nopeful" --Author Tooltip
...
SWEP.PrintName				= "Nerf Gun"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Nopeful.Retaliator.Single")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= nil				-- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage		= 70					-- Damage, in standard damage points.
SWEP.Primary.HullSize = 1.1 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
...
SWEP.Primary.SpreadRecovery = 0.9 --How much the spread recovers, per second.
...
SWEP.ViewModel			= "models/weapons/nerf/c_retaliator_n.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 35		-- This controls how big the viewmodel looks.  Less is more.
...
SWEP.WorldModel			= "models/weapons/nerf/w_retaliator_n.mdl" -- Weapon world model path
...
SWEP.ThirdPersonReloadDisable=true --Disable third person reload?  True disables.
...
SWEP.RunSightsPos = Vector (3,0,2) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector (-10,20,0) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-5.956, -3.628, 1.496)
SWEP.IronSightsAng = Vector(-1.326, -1.568, 1.312)
...
SWEP.Secondary.BashLength = 15 * 5.5	
