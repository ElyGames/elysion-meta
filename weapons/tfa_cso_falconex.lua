...
SWEP.PrintName				= "Power Falcon"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Falconex.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 5000					-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Anti-Stick Rifle"
--SWEP.NZPaPReplacement 	= "tfa_cso_awpcamo"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 31				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.MaxPenetrationCounter=30 --The maximum number of ricochets.  To prevent stack overflows.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_falconex.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_falconex.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.181, -4.824, 0.56)
SWEP.IronSightsAng = Vector(-1.407, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_falconex")
