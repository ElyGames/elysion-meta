...
SWEP.PrintName				= "AWP Elven Ranger"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 700					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_elven_ranger.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_elven_ranger.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV			= 22					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
...
SWEP.MuzzleFlashEffect = "cso_muz_elv_rng" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_elv_rng" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("ElvenRanger.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_elvenranger")
