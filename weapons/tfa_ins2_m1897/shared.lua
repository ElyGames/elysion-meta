...
SWEP.PrintName				= "M1897"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_M1897.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_M1897.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_m1897.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 56		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(1,-2,-0.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m1897.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.375, 0, 0.94)
SWEP.IronSightsAng = Vector(-0.05, -0.01, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.35, -2, -0.775)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.35, 0, -1.015)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.35, 0, -1.015)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.35, -3, -1.022)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.35, -3, -1.15)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.287, -3, -0.685)
...
SWEP.EventTable = {--[[
	[ACT_VM_PRIMARYATTACK] = {
		{ ["time"] = 0.2, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.Primary.Automatic then
				if CLIENT and game.SinglePlayer() then return end
				if wep:Clip1() > 0 then
					wep:DoPump()
				end
				wep:SetShotgunCancel(false)
			end
	...
	[ACT_VM_PULLBACK_LOW] = {
		{ ["time"] = 5 / 45, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
function SWEP:Think2(...)
	if self:GetStatus() == TFA.GetStatus("shooting") and self:GetStatusEnd() > CurTime() and self:GetFireMode() == 1 then
		self:DoPump()
	end
