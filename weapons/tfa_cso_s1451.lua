...
SWEP.PrintName				= "Brick Piece S1451 (A Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("S1451.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Two Bricks"
SWEP.NZPaPReplacement 	= "tfa_cso_katyusha"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_s1451.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_s1451.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["s1451"] = { type = "Model", model = "models/weapons/tfa_cso/w_s1451.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(5.132, 1.348, 1.661), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_s1451")
