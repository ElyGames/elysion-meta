...
SWEP.PrintName				= "Magnum Drill Expert"		-- Weapon name (Shown on HUD)
...
--SWEP.NZPaPReplacement 	= "tfa_cso_luger_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnum_drill_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnum_drill_expert.mdl" -- Worldmodel path
...
SWEP.Secondary.BashDamage = 2250
...
SWEP.Base				= "tfa_bash_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnumdrill_expert")
