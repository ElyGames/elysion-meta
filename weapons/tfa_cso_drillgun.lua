...
SWEP.PrintName				= "Drill Gun"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.PenetrationMultiplier	= 30
SWEP.Primary.HullSize = 2

--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("Drillgun.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 2000					-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Penetrator"
--SWEP.NZPaPReplacement 	= "tfa_cso_falconex"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 21				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_drillgun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_drillgun.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_drillgun")
