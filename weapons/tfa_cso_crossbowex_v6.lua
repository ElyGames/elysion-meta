...
SWEP.PrintName				= "Crossbow Advance Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Crossbow.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ClipSize			= 65					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 325				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crossbowex_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crossbowex_v6.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/crossbow/crossbow_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(6.046, -4.694, 1.197)
SWEP.IronSightsAng = Vector(0.773, 1.692, -2.416)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crossbowex_v6")
