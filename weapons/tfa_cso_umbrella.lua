...
SWEP.PrintName				= "Lightning SG-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Umbrella.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Umbrella"
--SWEP.NZPaPReplacement 	= "tfa_cso_m1887_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_umbrella.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_umbrella.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.393, 0, -0.205)
SWEP.IronSightsAng = Vector(2.375, 0, 5.171)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_umbrella")
