...
SWEP.PrintName				= "M95 Ghost Knight"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M95Ghost.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 3200					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95ghost.mdl" --Viewmodel path
...
SWEP.VElements = {
    ["eye"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tigerm_root", rel = "", pos = Vector(0.1, 1.4, -2.8), angle = Angle(-5, 170, 90), size = Vector(0.2, 0.35, 0.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m95ghost_eye", skin = 0, bodygroup = {} }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95ghost.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/m95tigerm_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(10.383, -9.2, 1.152)
...
SWEP.MuzzleFlashEffect = "cso_muz_m95tigerm" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_m95tigerm" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("M95Ghost.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95ghost")
