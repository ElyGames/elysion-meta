...
SWEP.UseHands = true
SWEP.ViewModel = "models/weapons/fml/doom/c_supershotgun.mdl"
...
SWEP.Primary.IronAccuracy = .065  -- Ironsight accuracy, should be the same for shotgunsess you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
