...
SWEP.PrintName				= "Desert Eagle Crimson Hunter Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CrimsonHunter.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Ent = "crimson_hunter_nade_expert"
...
SWEP.Secondary.Sound = Sound("CrimsonHunter.Throw")

-- nZombies Stuff
SWEP.NZWonderWeapon		= true	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Alucard"
...
SWEP.Primary.DefaultClip			= 450				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickDown			= 0.125					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crimson_hunter_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crimson_hunter_expert.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["nade"] = { type = "Model", model = "models/weapons/tfa_cso/w_crimsonhunter_nade_expert.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.591, 1.781, 0.626), angle = Angle(-4.645, 38.619, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.RunSightsPos = Vector(0, -1.009, 0)
SWEP.RunSightsAng = Vector(-16.223, 0, 0)
...
SWEP.IronSightsPos = Vector(6.945, -4.999, 1.245)
SWEP.IronSightsAng = Vector(0, 0, 3.207)
...
SWEP.MuzzleFlashEffect = "cso_muz_crm_hnt_ex" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_crm_hnt_ex" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("CrimsonHunter.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crimson_hunter_expert")
