...
SWEP.Gun = ("tfa_tfap_dmuzi")					-- must be the name of your swep
...
SWEP.PrintName				= "Dual MAC11s"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_tfap_dma11.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dma11.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_DMA11.1")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 2400			-- This is in Rounds Per Minute
...
SWEP.Primary.KickDown			= 0.125		-- Maximum down recoil (skeet)
...
SWEP.Primary.SpreadIncrement = 1/3 --What percentage of the modifier is added on, per shot.
