...
SWEP.PrintName				= "M95"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_m95_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.KickDown			= 0.75					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95")
