...
SWEP.Manufacturer = "FN America" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Oliver Mendes" --Author Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("INS2_M4A1.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("INS2_M4A1.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 740 -- This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp = 0.65 -- This is the maximum upwards recoil (rise)
...
--Range Related
SWEP.Primary.Range = 383 / 0.3 * 48 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2_m4a1/v_m4a1.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(-0.1, 1, 0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2_m4a1/w_m4a1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.75, -1, 0.6) --Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector(0, 0, 0) --Change this, using SWEP Creation Kit preferably

SWEP.IronSightsPos_GL = Vector(-1.365, 1, 1.54)
SWEP.IronSightsAng_GL = Vector(1.5,-1.2,0)

SWEP.IronSightsPos_Kobra = Vector(-2.7, -1, 0.4)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.7, -1, 0.6)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.7, -2, 0.6)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.75, -3, 0.4)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 =  Vector(-2.75, -2, 0)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
--[[INSPECTION]]--
SWEP.InspectPos = Vector(5, -5, -1)
SWEP.InspectAng = Vector(22.386, 34.417, 5) --Replace with a vector, in style of ironsights angle, to be used for inspection
...
SWEP.StatusLengthOverride = {
	["base_reload"] = 60 / 30,
	["base_reload_empty"] = 60 / 30,
	["foregrip_reload"] = 60 / 30,
	["foregrip_reload_empty"] = 60 / 30
...
SWEP.ViewModelBoneMods = {
	...
	["A_Suppressor"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, 0, 0), angle = Angle(0,0,0) },
	["A_LaserFlashlight"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(1.1, -3, 0), angle = Angle(0,0,0) },
	["A_Optic"] = { scale = Vector(.9,.9,.9), pos = Vector(0, -.2, 0), angle = Angle(0,0,0) },
	["laser_beam"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, -1.5, 0), angle = Angle(0,0,0) },
	["A_GL"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, 0, 0), angle = Angle(0,0,0) }
}
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1,1,1), pos = Vector(0, 0, 0), angle = Angle(0,0,0) },
	["ATTACH_Laser"] = { scale = Vector(1,1,1), pos = Vector(0.2, 0, 0), angle = Angle(0,180,90) },
	["ATTACH_GL"] = { scale = Vector(1,1,1), pos = Vector(1.5, 0, 0), angle = Angle(0,0,0) }
}


SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_carryhandle_m4.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_l.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["gl"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_gl.mdl", bone = "A_GL", rel = "", pos = Vector(0.5, 0.5, 0.5), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0,0,0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false }
}
...
SWEP.WElements = {
	...
	--["optic"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup3.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(-4.433, 0.041, 4.947), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	["gl"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_m203.mdl", bone = "ATTACH_GL", rel = "ref", pos = Vector(4, 0, 1.2), angle = Angle(0, 0, 0), size = Vector(0.7,0.7,0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_foregrip_sec1.mdl", bone = "ATTACH_Foregrip", rel = "ref", pos = Vector(1, -0.004, -0.322), angle = Angle(0, 0, 0), size = Vector(0.8,0.8,0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum" }, order = 5 },
	[7] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79"}, order = 2 },
	[8] = { offset = { 0, 0 }, atts = { "ins2_fg_grip", "ins2_fg_m203" }, order = 3 },
