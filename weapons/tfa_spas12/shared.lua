...
SWEP.Gun = ("tfa_spas12") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_spas12_shot.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_spas_12.mdl"	-- Weapon world model
