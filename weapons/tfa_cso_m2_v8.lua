...
SWEP.PrintName				= "M2 Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.ClipSize			= 300					-- This is the size of a clip
...
SWEP.Primary.IronAccuracy = .002875	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m2_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m2_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m2_v8")
