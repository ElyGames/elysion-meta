...
SWEP.PrintName				= "M4A1 Red"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Christmas Murica"
...
SWEP.Primary.IronAccuracy = .003375	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m4a1red.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
    ["Bone03"] = { scale = Vector(1, 1, 1), pos = Vector(0.015, 0, 0), angle = Angle(0, 0, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m4a1red.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.72, 0, 2.069)
SWEP.IronSightsAng = Vector(2.082, 1.394, 8.175)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m4a1red")
