...
SWEP.Gun = ("tfa_widowmaker") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Widowmaker"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_haz_mat_wolf/c_widowmaker.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_haz_mat_wolf/shotgun.mdl"	-- Weapon world model
SWEP.UseHands               = true
...
SWEP.Primary.Sound			= Sound("TFA_WIDOWMAKER1")		-- Script that calls the primary fire sound
...
SWEP.Primary.NumShots	= 15		-- How many bullets to shoot per trigger pull
...
SWEP.IronSightsPos = Vector(-1.4, 0, 0.72)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-1.4, 0, 0.72)
