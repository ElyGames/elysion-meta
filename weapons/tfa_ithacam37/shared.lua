...
SWEP.ViewModel				= "models/weapons/tfa_v_ithaca_m37shot.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_ithaca_m37.mdl"	-- Weapon world model
SWEP.Base 				= "tfa_shotty_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("weapons/xm1014/xm1014-1.ogg")		-- script that calls the primary fire sound
