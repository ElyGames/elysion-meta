...
SWEP.PrintName				= "Dual Micro UZIs"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/v_tfap_dmuzi.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dmuzi.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_MacElite.1")		-- Script that calls the primary fire sound
