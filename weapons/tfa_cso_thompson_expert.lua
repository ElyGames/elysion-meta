...
SWEP.PrintName				= "Thompson - Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Thompson.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 625					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Awakusu Typewriter"
SWEP.NZPaPReplacement 	= "tfa_cso_thompson_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 55					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 330				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickDown			= 0.110					-- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.Spread		= .0068					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0034	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thompson_expert.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -68.764, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_thompson_expert.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.772, -1.3, 3.029)
SWEP.IronSightsAng = Vector(-0.9, 0.04, 2.7)
...
SWEP.BlowbackBoneMods = {
	["windleo_tc_clip"] = { scale = Vector(1, 1, 1), pos = Vector(0, 5, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thompson_expert")
