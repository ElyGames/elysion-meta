...
SWEP.PrintName				= "Plasma Gun Chimera"		-- Weapon name (Shown on HUD)
...
SWEP.ProjectileEntity = "plasma_v6" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_plasmagun_v6.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_plasmagun_aqua_v6" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_plasmagun_v6.mdl" -- Weapon world model path
...
SWEP.MuzzleFlashEffect = "cso_muz_plasgun_v6" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_plasgun_v6" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_plasmagun_v6")
