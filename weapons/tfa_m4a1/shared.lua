...
SWEP.Gun = ("tfa_m4a1") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_m4a1_iron.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_m4a1_iron.mdl"	-- Weapon world model
