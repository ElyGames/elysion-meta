...
SWEP.PrintName				= "CROW-3"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW3.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ClipSize			= 64					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 384				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow3.mdl" -- Worldmodel path
