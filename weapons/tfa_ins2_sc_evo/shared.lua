...
SWEP.Manufacturer = "Česká zbrojovka Uherský Brod" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_SCORPION_EVO.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_SCORPION_EVO.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_scorpion_evo.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 56		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(1,0,-0.25) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_scorpion_evo.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.171, -2.965, 1.299)
SWEP.IronSightsAng = Vector(0.142, -0.02, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.223, -3.5, 0.39)
SWEP.IronSightsAng_Kobra = Vector(0, -0.18, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.226, -3.5, 0.402)
SWEP.IronSightsAng_EOTech = Vector(0, -0.19, 0)

SWEP.IronSightsPos_RDS = Vector(-2.226, -3.5, 0.401)
SWEP.IronSightsAng_RDS = Vector(0, -0.19, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.205, -4.5, 0.398)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.205, -4.0, -0.02)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0.0)

SWEP.IronSightsPos_PO4X = Vector(-2.1375, -3.7, 0.525)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0.07)
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_scorpion_evo.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
