...
SWEP.PrintName				= "KSG-12 Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 72					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 72					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Metallian-24 Master"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ksg12_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ksg12_master.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ksg12_master")
