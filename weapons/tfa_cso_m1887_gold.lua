...
SWEP.PrintName				= "Winchester M1887 - Gold"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M1887.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickHorizontal			= 0.75					-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.IronAccuracy = .0325	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1887_gold.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1887_gold.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.33, -3.1, 1.4)
SWEP.IronSightsAng = Vector(1, 0, 7.3)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1887_gold")
