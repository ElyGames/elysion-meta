...
SWEP.PrintName = "MTs255-12"
SWEP.Manufacturer = "TsKIB SOO"
...
SWEP.Primary.Sound = Sound("TFA_INS2.WF_SHG10.1")
...
SWEP.ViewModel = "models/weapons/tfa_ins2/c_mc255.mdl"
...
SWEP.WorldModel = "models/weapons/tfa_ins2/w_mc255.mdl"
SWEP.HoldType = "ar2"
...
SWEP.VElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_ins_shotgun.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(-0.29, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_ins_shotgun.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.EventTable = {
	["base_ready"] = {
		...
		{time = 22 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Open")},
		{time = 28 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
		{time = 52 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Close")},
	...
	["base_dryfire"] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Empty")},
	},
	["base_reload"] = {
		-- {time = 0, type = "sound", value = Sound("TFA_INS2.Draw"), client = true, server = false},
		{time = 13 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
		{time = 15 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Open")},
		{time = 26 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
		{time = 34 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.ClipOut")},
		{time = 44 / 30, type = "sound", value = Sound("TFA_INS2.Holster"), client = true, server = false},
		{time = 53 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
		{time = 72 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.ClipIn")},
		{time = 87 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
		{time = 93 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Close")},
		{time = 110 / 30, type = "sound", value = Sound("TFA_INS2.LeanIn"), client = true, server = false},
	},
	["iron_dryfire"] = {
		{time = 1 / 30, type = "sound", value = Sound("TFA_INS2.WF_SHG10.Empty")},
	},
