...
SWEP.Gun = ("tfa_famas") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "FAMAS G2"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_tct_famas.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_tct_famas.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("weapons/famas/famas-1.ogg")		-- Script that calls the primary fire sound
