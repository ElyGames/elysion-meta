...
SWEP.Manufacturer = "Diemaco" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "C7E"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.C7E.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.C7E.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_c7e.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 68		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0.8, -1.5, -0.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng = Vector(0,0,0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
SWEP.VMPos_Additive = false --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, run, whateverelse
SWEP.Bodygroups_V = nil
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_c7e.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.414, -2, -0.315)
SWEP.IronSightsAng = Vector(-0.002, 0.003, 0)

SWEP.IronSightsPos_GL = Vector(0.18, -4, 0.375)
SWEP.IronSightsAng_GL = Vector(1.143, 0.079, -2.401)

SWEP.IronSightsPos_Kobra = Vector(-2.417, -4, -0.458)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 60

SWEP.IronSightsPos_EOTech = Vector(-2.417, -4, -0.445)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 76

SWEP.IronSightsPos_RDS = Vector(-2.417, -4, -0.446)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 55

SWEP.IronSightsPos_2XRDS = Vector(-2.4145, -6, -0.448)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 63

SWEP.IronSightsPos_C79 = Vector(-2.4165, -6, -0.577)
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Foregrip"] = { scale = wscale * .75, pos = Vector(0, 5.5, 0), angle = Angle(0, 0, 0) },
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_ironsights_c7e_unfolded.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["sights_folded_alt"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_ironsights_c7e_alt.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_ironsights_c7e_folded.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},

	["front_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_ironsights_c7e_front.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["angledgrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_basegrip_c7e.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ironsights_c7e_unfolded.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["sights_folded_alt"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ironsights_c7e_alt.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ironsights_c7e_folded.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},

	["front_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ironsights_c7e_front.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["angledgrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_basegrip_c7e.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
...
SWEP.Attachments = {
	...
	[2] = {atts = {"ins2_si_c7e_alt", "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79"}},
	[3] = {atts = {"ins2_fg_grip", "ins2_fg_m203"}},
...
SWEP.ShellModel = "models/weapons/tfa_ins2/w_c7e_shell.mdl"
SWEP.ShellScale = 1.5
SWEP.ShellYaw = 0
