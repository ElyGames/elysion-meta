...
SWEP.PrintName				= "Tiamat MK-4"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TiamatMK4.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 125					-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 480				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ProjectileEntity = "plasmaexd" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_plasmaexd.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_plasmagunexd.mdl" -- Weapon world model path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/plasmagunexd_scope.png", "smooth"),
...
SWEP.IronSightsAng = Vector(-2.7, -0.2, 0)
...
SWEP.MuzzleFlashEffect = "cso_muz_plasgunexd" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.Secondary.Ent = "plasmaex"
SWEP.Secondary.Model = "models/items/ar2_grenade.mdl" --Projectile Model
SWEP.Secondary.Damage = 2400 --Grenade Damage
SWEP.Secondary.Velocity = 26000 --Grenade Velocity
...
function SWEP:AltAttack()
	...
	timer.Simple(2, function()
		if SERVER then
			self:EmitSound("TiamatMK4.Fire3")
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_plasmagunexd")
