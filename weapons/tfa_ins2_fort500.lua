...
SWEP.Manufacturer = "NPO Fort" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "Fort-500"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_FORT500.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_FORT500.2") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 13 -- Damage, in standard damage points.
...
SWEP.Primary.KickHorizontal = 0.9 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_fort500.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_fort500.mdl" -- Weapon world model path
...
SWEP.ISOffset = Vector(-0.15,0,0.35)
SWEP.ISOffset_At = Vector(-0.155,1,-0.047)

SWEP.IronSightsPos = Vector(-2.05, -2, 0.85) + SWEP.ISOffset
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.048, -4, -0.151) + SWEP.ISOffset_At
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.048, -4, -0.39) + SWEP.ISOffset_At
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.048, -4, -0.391) + SWEP.ISOffset_At
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.045, -4, -0.395) + SWEP.ISOffset_At
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.048, -4, -0.523) + SWEP.ISOffset_At
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-1.983, -4, -0.058) + SWEP.ISOffset_At
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
--[[INSPECTION]]--
SWEP.InspectPos = Vector(5, -4.75, -2.787)
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD_EMPTY] = 64 / 34,
	[ACT_VM_RELOAD] = 7 / 36,
	["foregrip_reload_empty"] = 64 / 35,
	["foregrip_reload"] = 7 / 36,
...
SWEP.EventTable = {
	[ACT_SHOTGUN_PUMP] = {
		{ ["time"] = 8 / 35, ["type"] = "lua", ["value"] = function(wep,vm)
	...
	[ACT_VM_PULLBACK] = {
		{ ["time"] = 9 / 35, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
	...
	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 25 / 35, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
	...
	[ACT_VM_PULLBACK_LOW] = {
		{ ["time"] = 9 / 45, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(0.55, 0.55, 0.55), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_Modkit"] = { scale = Vector(1,1,1), pos = Vector(0, -1, -0.25), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_kobra_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_kobra") or nil,
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_eotech_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_eotech") or nil,
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_rds_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_rds") or nil,
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimp2x.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "A_Muzzle", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec2.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_sec_shotgun.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_modkit_5.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[8] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
	[9] = { offset = { 0, 0 }, atts = { "ins2_fg_grip" }, order = 3 },
	[6] = { offset = { 0, 0 }, atts = { "ins2_ub_laser" }, order = 4 },
	[3] = { offset = { 0, 0 }, atts = { "sg_frag","sg_slug" }, order = 5 },
...
SWEP.RTAttachment_2XRDS = 8
SWEP.ScopeOverlayTransforms_2XRDS = { 0, -0.55 }
SWEP.ScopeDistanceMin_2XRDS = 18
SWEP.ScopeDistanceRange_2XRDS = 8

SWEP.RTAttachment_C79 = 8
SWEP.ScopeOverlayTransforms_C79 = { 0, -0.58 }
SWEP.ScopeDistanceMin_C79 = 18
SWEP.ScopeDistanceRange_C79 = 8

SWEP.RTAttachment_PO4X = 8
SWEP.ScopeOverlayTransforms_PO4X = { -0.008, -0.5 }
SWEP.ScopeDistanceMin_PO4X = 18
