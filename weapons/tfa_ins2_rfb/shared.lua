...
SWEP.Manufacturer = "Kel-Tec" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_RFB.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_RFB.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_rfb.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_rfb.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.62, -2.445, 0.709)
SWEP.IronSightsAng = Vector(0, -0.076, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.624, -3.5, -0.415)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.624, -3.5, -0.702)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.624, -6, -0.778)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.621, -4, -0.781)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.624, -3, -1.205)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.549, -2.912, -0.275)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)

SWEP.IronSightsPos_Mosin = Vector(-2.595, -5, -0.245)
SWEP.IronSightsAng_Mosin = Vector(0, 0, 0)

SWEP.IronSightsPos_MX4 = Vector(-2.635, -1.912, -0.555)
...
SWEP.StatusLengthOverride = {
	...
	[ACT_VM_RELOAD_DEPLOYED] = 62 / 30,
	[ACT_VM_RELOAD_IDLE] = 72 / 30
...
SWEP.ScopeDistanceMin_2XRDS = 8.5
...
SWEP.ScopeDistanceMin_Mosin = 6.5

SWEP.RTAttachment_MX4 = 8
SWEP.ScopeOverlayTransforms_MX4 = {
	0,-0.3
}
SWEP.ScopeDistanceRange_MX4 = 8
SWEP.ScopeDistanceMin_MX4 = 11
