SWEP.Gun					= ("tfa_fate") --Make sure this is unique.  Specically, your folder name.
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "tfa_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Base				= "tfa_gun_base"
SWEP.Category				= "COD Online" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = nil --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Zé" --Author Tooltip
...
SWEP.PrintName				= "Fate"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("weapons/m4a1/m4a1_unsil-fate.ogg")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound 			= Sound("weapons/m4a1/m4a1-fate.ogg")				-- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage		= 85					-- Damage, in standard damage points.
SWEP.Primary.HullSize = 0.1 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
...
SWEP.ViewModel			= "models/weapons/v_rif_m4a1_fate.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/w_rif_m4a1_fate.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector (0.519, -4.824, -1) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector (0, 61.206, -11.256) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector (-3.28, 0, 0.66) --Change this, using SWEP Creation Kit preferably
...
SWEP.TracerName 		= "" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.TracerDelay		= 0.1 --Delay for lua tracer effect
