...
SWEP.DisplayColor = Color(252, 61, 3, 255)
...
function SWEP:CycleFireMode()
	...
	if fmn == "taser" then
		self.DisplayColor = Color(3, 223, 252, 255)
		self.Owner:EmitSound("weapons/tfa_ins2/codol_freedom/mk18_magin.ogg",100,100)
		self.Primary_TFA.Damage = 0
	else
		self.DisplayColor = Color(252, 61, 3, 255)
...
hook.Add("TFA_PrimaryAttack", "Summe:TFATaserSupport", function(self)
	...
	if ( !self.IsTaser ) then return end
		...
		if fmn == "taser" then
			...
			if SERVER then
				wep.Owner:EmitSound("weapons/tfa_ins2/codol_freedom/mk18_fp.ogg",100,100)
			end
