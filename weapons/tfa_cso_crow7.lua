...
SWEP.PrintName				= "CROW-7"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow7.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow7.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.131, -4.889, -0.158)
SWEP.IronSightsAng = Vector(0, -1.504, 0)
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		...
		{ time = 35 / 30, type = "lua", value = function(wep) wep:CrowEnableCheck() end},
		{ time = 44 / 30, type = "lua", value = function(wep) wep:CrowChooseReloadAnim() end},
	},
	[ACT_VM_RELOAD_END] = {
		{ time = 30 / 30, type = "lua", value = function(wep) wep:CrowCompleteReload() end},
	},
	[ACT_VM_RELOAD_END_EMPTY] = {
		{ time = 42 / 30, type = "lua", value = function(wep) wep:CrowCompleteReload() end},
	},
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crow7")
