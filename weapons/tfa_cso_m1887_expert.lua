...
SWEP.PrintName				= "Winchester M1887 - Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Ghost Recon '87"
SWEP.NZPaPReplacement 	= "tfa_cso_m1887_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1887_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1887_expert.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1887_expert")
