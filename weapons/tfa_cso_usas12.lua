...
SWEP.NZPaPName				= "20 rounds of assshots"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_usas12.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_usas12transgear" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_usas12.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_usas12")
