...
SWEP.PrintName				= "M4A1 Dragon"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "ChingChong Murica"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m4a1dragon.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m4a1dragon.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m4a1dragon")
