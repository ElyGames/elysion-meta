...
SWEP.Author				= "Deika & Raven" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "Blast zombies with this quadruple barrelled super shotgun" --Purpose Tooltip
...
SWEP.ViewModel			= "models/weapons/blundergat/c_blundergat.mdl" --Viewmodel path
...
SWEP.VMPos = Vector(0.000, 0.0, 0.00)
