SWEP.Gun					= ("weapon_deussmg_nope") --Make sure this is unique.  Specically, your folder name.
...
SWEP.PrintName				= "Hurricane TMP-18"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("N_DEUSSMG.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/smg/c_deussmg_nope.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/smg/smg.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector (-5,0,0) --Change this, using SWEP Creation Kit preferably
