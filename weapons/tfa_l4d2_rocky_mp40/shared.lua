...
SWEP.PrintName				= "MP-40"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_ROCKY_MP40.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 32*4					-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Range Related
SWEP.Primary.Range = 328.084*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsMoveSpeed = 0.95*0.8 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_rocky_mp40u.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_rocky_mp40u.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4, -8.507, 1.91)
