...
SWEP.PrintName				= "Gae Bolg Chimera"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Speargun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 24					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

--[[PROJECTILES]]--

SWEP.Primary.Projectile = "spear_arrow_v6"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_spear_v6.mdl"
SWEP.Primary.ProjectileVelocity = 5000 -- 76 meters to inches * 4/3 ( 16 / 12 hammer to inches )
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_speargun_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_speargun_v6.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_speargun_v6")
