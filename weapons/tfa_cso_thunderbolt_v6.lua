...
SWEP.PrintName				= "Thunderbolt Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.PenetrationMultiplier	= 15
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thunderbolt_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_thunderbolt_v6.mdl" -- Weapon world model path
...
SWEP.TracerName 		= "cso_tra_thunbolt_v6" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thunderbolt_v6")
