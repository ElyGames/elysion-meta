...
SWEP.Gun = ("tfa_tfap_dp220")					-- must be the name of your swep
...
SWEP.PrintName				= "Dual P210s"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_tfap_dp210.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dp210.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_P210.1")		-- Script that calls the primary fire sound
