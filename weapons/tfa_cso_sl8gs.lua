...
SWEP.PrintName				= "SL8 10th Anniversary"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 220					-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "SUPER BROKEN SHIT"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sl8gs.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sl8gs.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sl8gs")
