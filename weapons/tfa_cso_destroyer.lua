...
SWEP.PrintName				= "Destroyer"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Destroyer.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 600					-- Damage, in standard damage points.
SWEP.Primary.BlastRadius	= 30               -- Radius for DMG_BLAST
...
SWEP.Primary.RPM_Semi				= 75					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Obliterator"
...
SWEP.Primary.DefaultClip			= 33				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_destroyer.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_destroyer_plastic" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_destroyer.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/destroyer/destroyer_scope.png", "smooth"),
	["ScopeBorder"] = Color(0,0,5,255),
...
SWEP.IronSightsPos = Vector(10.666, -9.087, 2.453)
SWEP.IronSightsAng = Vector(0, 0, -2.168)
...
SWEP.MuzzleFlashEffect = "cso_muz_dstryr" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

SWEP.Primary.ImpactEffect = "exp_destroyer"

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_dstryr" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_destroyer")
