...
SWEP.PrintName				= "SKULL-8"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SKULL8.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull_8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull_8.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-11.601, -36.965, 0)
...
SWEP.IronSightsPos = Vector(-3.941, -3.227, 1.379)
SWEP.IronSightsAng = Vector(-0.002, -1, -0.53)
--[[INSPECTION]]--
...
//	[ACT_VM_HITCENTER] = 2,
} --Override this if you want to change the length of a sequence but not the next idle --Override this if you want to change the length of a sequence but not the next idle
...
SWEP.Secondary.BashDelay = 0.9
SWEP.Secondary.BashDamage = 250
SWEP.Secondary.BashLength = 115

SWEP.Secondary.BashSound = Sound("common/null.ogg")
SWEP.Secondary.BashHitSound = Sound("common/null.ogg")
SWEP.Secondary.BashHitSound_Flesh = Sound("common/null.ogg")

SWEP.Secondary.BashDamageType = bit.bor(DMG_SLASH,DMG_ALWAYSGIB)
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull8")
