...
SWEP.PrintName				= "Blaser R93 Tactical"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("R93.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 165					-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 35				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.525 				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.425					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_r93.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_r93.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/aw50/aw50_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(5.025, -5.428, 1.809)
SWEP.IronSightsAng = Vector(-1.407, 0, 6.611)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_r93")
