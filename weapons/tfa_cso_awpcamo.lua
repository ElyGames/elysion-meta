...
SWEP.PrintName				= "AWP Camouflage"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_awpcamo.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_awpcamo.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_awpcamo")
