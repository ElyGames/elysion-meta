...
SWEP.PrintName				= "M3 Boom"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m3boom.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 10 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 16 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
SWEP.NZPaPName				= "Concert Recital"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m3boom.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m3boom.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-11.869, -30.129, 16.056)
