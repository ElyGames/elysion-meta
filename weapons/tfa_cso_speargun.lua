...
SWEP.PrintName				= "Gae Bolg"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Projectile = "spear_arrow"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_spear.mdl"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_speargun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_speargun.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_speargun")
