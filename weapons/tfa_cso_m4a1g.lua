...
SWEP.PrintName				= "M4A1 Scope"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Modern + Scope Murica"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g_m4a1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_g_m4a1.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.7, 0, 3)
SWEP.IronSightsAng = Vector(0.5, 1.2, 8.175)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m4a1g")
