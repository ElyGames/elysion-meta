...
SWEP.PrintName						= "Wastelander M5"
SWEP.Type							= "A trusty companion for those long walks in hard vacuum."
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("TFA_WASTELANDER_FIRE.1")
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = { -- providing zero point is not required
		...
		{range = 5+8, damage = 1},
		{range = 12+8, damage = 0.60},
		{range = 14+8, damage = 0.40},
		{range = 16+8, damage = 0.30},
		{range = 18+8, damage = 0.20},
		{range = 20+8, damage = 0.10},
		{range = 22+8, damage = 0.05},
		{range = 24+8, damage = .02},
		{range = 26+8, damage = 0},
	}
}
...
SWEP.ViewModel						= "models/weapons/WastelanderM5/c_WastelanderM5.mdl"
SWEP.WorldModel						= nil
...
SWEP.BlowbackVector 				= Vector(0, -10, 0)
...
SWEP.IronSightsPos = Vector(-4.55, -2, 1.5)
...
SWEP.VMPos = Vector(-1, -4.2, 0) -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng = Vector(.35, .5, -1) -- The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.ViewModelBoneMods = {
	...
	//["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-7, -15, 0) },
	//["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 5, 0) },
	//["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 5, 0) }
}
...
SWEP.WElements = {
	["world"] = { type = "Model", model = SWEP.ViewModel, bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-10, 5, -4), angle = Angle(-12.5, 1, 180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = { [1] = 0 } }
}
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{["time"] = 0, type = "sound", value = Sound("TFA_WASTELANDER_RELOADIN.1")},
	},
	[ACT_SHOTGUN_RELOAD_START] = {
		//{ ["time"] = 0, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{["time"] = 0, type = "sound", value = Sound("TFA_WASTELANDER_RELOADSTART.1")}
	},
	[ACT_SHOTGUN_RELOAD_FINISH] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = 0.15, type = "sound", value = Sound("TFA_WASTELANDER_RELOADEND.1")}
	},
	[ACT_VM_PRIMARYATTACK] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = .44, type = "sound", value = Sound("TFA_WASTELANDER_PUMP.1")}
	},
	[ACT_VM_PRIMARYATTACK_1] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = .55, type = "sound", value = Sound("TFA_WASTELANDER_PUMP.1")}
	}, 
	[ACT_VM_DRAW] = {															
		{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_WASTELANDER_DRAW.1") }
	}
}

SWEP.SequenceRateOverride= {
	[ACT_SHOTGUN_RELOAD_FINISH] = 1.1, 
	[ACT_SHOTGUN_RELOAD_START] = 1,
	[ACT_VM_PRIMARYATTACK] = 1,
	[ACT_VM_PRIMARYATTACK_1] = 1.25,
	[ACT_VM_DRAW] = 1,
	[ACT_VM_HOLSTER] = 1,
}
