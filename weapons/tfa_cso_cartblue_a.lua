...
SWEP.PrintName				= "Lightning Dao-1"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("CartBlue.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("CartBlue.Fire2") -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage_Regular		= 29					-- Damage, in standard damage points.
SWEP.Primary.Damage		= SWEP.Primary.Damage_Regular
SWEP.Primary.Damage_Secondary		= 58					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= true					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 685					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 685					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Sci-Fi Rifle"
...
SWEP.Primary.KickHorizontal			= 0.06					-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_cartblue.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_cartblue.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.447, -6.593, 2.226)
SWEP.IronSightsAng = Vector(6.514, -0.144, 0.21)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_cartblue")
...
function SWEP:Think2(...)
	if self:GetStatus() == TFA.Enum.STATUS_SILENCER_TOGGLE and self:GetStatusEnd() <= CurTime() then
		...
		if self:GetSilenced() then
			...
			self.Primary_TFA.KickUp	= 0.12	
            self.Primary_TFA.KickDown	= 0.06		
            self.Primary_TFA.KickHorizontal	= 0.10	
			self.data.ironsights = 1
			self.WorldModel			= "models/weapons/tfa_cso/w_cartblue_b.mdl"
			self.Offset = {
			        Pos = {
        Up = -4.6,
        Right = 0.5,
