...
SWEP.PrintName				= "Needler"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Needler.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Staple to the face"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_needler.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_needler.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.78, 0, 3.039)
SWEP.IronSightsAng = Vector(-1.25, 0, 2.431)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_needler")
