...
SWEP.PrintName				= "Walther WA2000 - Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("WA2000.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 108					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= true					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 135					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 135					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "The Blast Falcon - Expert"
SWEP.NZPaPReplacement 	= "tfa_cso_wa2000_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.425					-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.375					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.0175				-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.SpreadRecovery = 2.0 --How much the spread recovers, per second.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_wa2000_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_wa2000_expert.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(5.813, -1.114, 1.159)
SWEP.IronSightsAng = Vector(1.978, 0.474, -2.324)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_wa2000_expert")
