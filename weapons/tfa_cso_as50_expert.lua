...
SWEP.PrintName				= "AI AS50 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("As50.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Ass X50"
SWEP.NZPaPReplacement 	= "tfa_cso_as50_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 57				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.575				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.475					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_as50_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_as50_v6.mdl" -- Worldmodel path
...
SWEP.Secondary.IronFOV			= 22.5					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(7.382, -2.878, 1.406)
SWEP.IronSightsAng = Vector(-0.908, -1.053, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_as50_expert")
