...
SWEP.PrintName				= "Ethereal"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SF Ethereal.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .0054					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ethereal.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ethereal.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-18.222, 0, 0)
...
SWEP.IronSightsPos = Vector(10.048, -8.169, 0.24)
SWEP.IronSightsAng = Vector(4.035, 4.507, 0.194)
...
SWEP.BlowbackVector = Vector(-0.15,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.MuzzleFlashEffect = "cso_muz_ethereal" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "tra_ethereal" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ethereal")
