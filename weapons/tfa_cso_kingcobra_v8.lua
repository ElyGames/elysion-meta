...
SWEP.PrintName				= "King Cobra Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 88					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= false					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 210					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 210					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_kingcobra_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_kingcobra_v8.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_kingcobra_v8")
