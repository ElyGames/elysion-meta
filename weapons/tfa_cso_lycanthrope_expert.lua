...
SWEP.PrintName				= "SG552 Lycanthrope Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage_Regular		= 105					-- Damage, in standard damage points.
...
SWEP.Primary.Damage_Secondary		= 265				-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Celestia"
SWEP.NZPaPReplacement 	= "tfa_cso_sg552_cerberus"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 62					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 312				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickDown			= 0.16					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_lycanthrope_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_lycanthrope_expert.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.01, -2.59, 1.139)
SWEP.IronSightsAng = Vector(0, 6.835, 0)
...
function SWEP:Holster( ... )
	self:StopSound("Lycanthrope.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_lycanthrope_expert")
...
function SWEP:Think2(...)
	if self:GetIronSightsProgress() <= 0.5 and self:GetCSO_SwitchState() then
		...
		self.Primary_TFA.KickUp	= 0.22	
        self.Primary_TFA.KickDown	= 0.16		
	...
	elseif self:GetIronSightsProgress() > 0.5 and not self:GetCSO_SwitchState() then
		...
		self.Primary_TFA.RPM = 350
		self.Primary_TFA.AmmoConsumption = 1
		self.Primary_TFA.NumShots = 1
		self.Primary_TFA.KickUp	= 0.11	
