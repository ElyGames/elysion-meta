...
SWEP.PrintName				= "M95 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M95.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 30					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Anti Choppa"
SWEP.NZPaPReplacement 	= "tfa_cso_m95_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.725				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.725					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95_expert.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.166, 0, 1.498)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95_expert")
