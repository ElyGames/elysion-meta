...
SWEP.PrintName				= "M3 Big Shark"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M3Shark.Fire")	-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m3shark.mdl" --Viewmodel path
...
SWEP.VElements = {
	["smoke_right"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "bone_gill02", rel = "", pos = Vector(1, 2.5, -3), angle = Angle(90, 0, 20), size = Vector(0.25, 0.25, 0.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m3shark_smoke2", skin = 0, bodygroup = {} },
	["smoke_left"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "bone_gill02", rel = "", pos = Vector(-6, 2.5, 2), angle = Angle(0, 0, 0), size = Vector(0.25, 0.25, 0.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m3shark_smoke", skin = 0, bodygroup = {} }
}


--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m3shark.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_shark" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_shark" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m3shark")
