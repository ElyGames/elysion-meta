...
SWEP.PrintName = "Desert Eagle [Stock]"

SWEP.ViewModel = "models/weapons/tfa_ava/c_deagle.mdl" --Viewmodel path
SWEP.ViewModelFOV = 56
SWEP.UseHands = true

SWEP.WorldModel = "models/weapons/tfa_ava/w_deagle.mdl" --Viewmodel path
...
SWEP.Primary.Sound = "TFA_AVA_DEAGLE.1"
...
SWEP.IronSightsPos = Vector(-9.375, -9.398, 2.759)
...
SWEP.ViewModelBoneMods = {
        ["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-9.256, 28.465, -10.905) }
}
SWEP.BlowbackEnabled = true
SWEP.BlowbackVector = Vector(0.0,-3.5,0.1)
SWEP.Blowback_PistolMode = true
SWEP.BlowbackBoneMods = {
        ["Bone01"] = { scale = Vector(1, 1, 1), pos = Vector(-1.3, 4.827, -0.18) / 1.5, angle = Angle(0, 0, 0) }
}
        ...
        [ACT_VM_DRAW] = {
                {
                        ["time"] = 1 / 30,
                        ["type"] = "sound",
                        ["value"] = Sound("TFA_AVA_DEAGLE.Draw")
                }
        },
        [ACT_VM_RELOAD] = {
                {
                        ["time"] = 12 / 30 - 0.1,
                        ["type"] = "sound",
                        ["value"] = Sound("TFA_AVA_DEAGLE.MagOut")
                },
                {
                        ["time"] = 43 / 30,
                        ["type"] = "sound",
                        ["value"] = Sound("TFA_AVA_DEAGLE.MagIn")
                },
                {
                        ["time"] = 60 / 30 - 0.05,
                        ["type"] = "sound",
                        ["value"] = Sound("TFA_AVA_DEAGLE.Slide")
                }
        }
}