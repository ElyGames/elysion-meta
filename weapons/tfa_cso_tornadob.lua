...
SWEP.PrintName				= "Tornado (Charging)"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.HullSize = 1.5

--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("Tornado.Fire2")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "100%"
SWEP.NZPaPReplacement 	= "tfa_cso_tornadoc"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tornado_b.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tornado.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.8985, -8.681, -1.195)
SWEP.IronSightsAng = Vector(0, 0, -0.7)
...
SWEP.TracerName 		= "cso_tra_tornado_b" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tornadob")
