...
SWEP.Gun = ("tfa_acr") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_rif_msda.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_masada_acr.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(2.665, 0, 0.629)
SWEP.SightsAng = Vector(0.12, 0, -0.25)
