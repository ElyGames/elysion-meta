...
SWEP.PrintName				= "Starlight Rolling Shooter"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MagicSG.Fire")	-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magicsg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magicsg.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magicsg")
