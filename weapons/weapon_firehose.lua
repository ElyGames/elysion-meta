	...
	if ( IsFirstTimePredicted() ) then
		...
		if ( SERVER ) then
			...
			if ( self.Owner:KeyPressed( IN_ATTACK ) or !self.Sound ) then
				...
				self.Sound = CreateSound( self.Owner, Sound( "weapons/extinguisher/fire1.ogg" ) )
...
function SWEP:PlaySound()
	self:EmitSound( "weapons/extinguisher/release1.ogg", 100, math.random( 95, 110 ) )
end
...
SWEP.WepSelectIcon = Material( "icons/norm.png" )
