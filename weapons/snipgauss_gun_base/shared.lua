...
function SWEP:RicochetCallback(bouncenum, attacker, tr, dmginfo)
	...
	bulletmiss = {}
		bulletmiss[1]=Sound("weapons/fx/nearmiss/bulletLtoR03.ogg")
		bulletmiss[2]=Sound("weapons/fx/nearmiss/bulletLtoR04.ogg")
		bulletmiss[3]=Sound("weapons/fx/nearmiss/bulletLtoR06.ogg")
		bulletmiss[4]=Sound("weapons/fx/nearmiss/bulletLtoR07.ogg")
		bulletmiss[5]=Sound("weapons/fx/nearmiss/bulletLtoR09.ogg")
		bulletmiss[6]=Sound("weapons/fx/nearmiss/bulletLtoR10.ogg")
		bulletmiss[7]=Sound("weapons/fx/nearmiss/bulletLtoR13.ogg")
		bulletmiss[8]=Sound("weapons/fx/nearmiss/bulletLtoR14.ogg")
...
function SWEP:BulletPenetrate(bouncenum, attacker, tr, paininfo)
	...
	local tbl = {
		["models/drover/2w_shield.mdl"] = true,
		["models/drover/shield.mdl"] = true,
		["models/drover/w_shield.mdl"] = true,
		["models/drover/shield_d.mdl"] = true,
	}
	if IsValid(tr.Entity) and tbl[tr.Entity:GetModel()] then return false end
