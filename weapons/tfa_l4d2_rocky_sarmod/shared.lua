...
SWEP.PrintName				= "Galil SAR-Ext"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_ROCKY_GALILSAR.1")				-- This is the sound of the weapon, when you shoot.
...
--Range Related
SWEP.Primary.Range = 1640.42*16 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.IronSightsMoveSpeed = 0.9*0.8 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_galil_sar_modified.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_galil_sar_modified.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.77, -3.984, 0.93)
