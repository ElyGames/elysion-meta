...
SWEP.PrintName				= "Heaven Scorcher"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.BlastRadius	= 50              -- Radius for DMG_BLAST
...
SWEP.Primary.DefaultClip			= 180				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_Heaven_scorcher.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_heaven_scorcher.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_heaven" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "tra_heaven" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Primary.ImpactEffect = "exp_heaven"
--[[EVENT TABLE]]--
...
function SWEP:Holster( ... )
	self:StopSound("HeavenScorcher.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_heavenscorcher")
