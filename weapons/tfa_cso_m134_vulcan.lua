...
SWEP.PrintName				= "M134 Vulcan"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M134Vulcan.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 900				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m134_vulcan.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m134_vulcan.mdl" -- same case UHGI;DFSD/
...
SWEP.TracerName 		= "cso_tra_134_vul" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m134_vulcan")
