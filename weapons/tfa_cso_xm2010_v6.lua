...
SWEP.PrintName				= "Remington XM2010 ESR Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_xm2010_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.475				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_xm2010_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_xm2010_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_xm2010_v6")
