...
SWEP.PrintName				= "Brick Piece M777 (B Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("HOWITZER.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "I WANT THAT!!!"
SWEP.NZPaPReplacement 	= "tfa_cso_m777"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ProjectileEntity = "howitzer_missile" --Entity to shoot
SWEP.ProjectileVelocity = 3600 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_missile_v7.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_howitzer.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_howitzer.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.38, -2.31, -3.366)
SWEP.IronSightsAng = Vector(19.04, 10.236, -8.197)
...
function SWEP:Holster( ... )
	self:StopSound("HOWITZER.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_howitzer")
