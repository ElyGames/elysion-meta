...
SWEP.PrintName				= "MP5 Gold"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MP5.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Golden Heavy Machine Gun"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mp5g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mp5g.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mp5g")
