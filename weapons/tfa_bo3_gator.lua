...
SWEP.Purpose = "Semi-automatic shotgun. Reliable 2 shot kill."
SWEP.Type_Displayed = "Shotgun"
SWEP.Author = "Olli, Fox"
SWEP.Slot = 3
SWEP.PrintName = "205 Brecci"
SWEP.DrawCrosshair = true
SWEP.DrawCrosshairIronSights = false

--[Model]--
SWEP.ViewModel			= "models/weapons/bo3/gator/base/c_bo3_gator.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/bo3/gator/base/w_bo3_gator.mdl"
SWEP.HoldType = "ar2"
...
SWEP.IronSightsPos = Vector(-3.5, -1.5, 1.05)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.IronSightsPos_ELO = Vector(-3.5, -1.5, 0.465)
SWEP.IronSightsAng_ELO = Vector(0, 0, 0)
SWEP.IronSightsPos_REFLEX = Vector(-3.505, -1.5, 0.435)
SWEP.IronSightsAng_REFLEX = Vector(0, 0, 0)
SWEP.IronSightsPos_BOA3 = Vector(-3.505, -1.5, 0.5)
...
--[NZombies]--
SWEP.NZPaPName = "Stellar Screech"
...
{ ["time"] = 15 / 30, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_back") },
{ ["time"] = 20 / 30, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_forward") },
},
[ACT_VM_RELOAD] = {
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 15 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 45 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 1 / 30, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 15 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 45 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
{ ["time"] = 80 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_back") },
{ ["time"] = 85 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_forward") },
},
--[Extmag]--
["reload_extmag"] = {
{ ["time"] = 1 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 15 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 40 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 50 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
},
["reload_empty_extmag"] = {
{ ["time"] = 1 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 15 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 40 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 50 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
{ ["time"] = 75 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_back") },
{ ["time"] = 80 / 35, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_forward") },
},
--[Fastmag]--
["reload_fast"] = {
{ ["time"] = 1 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 5 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 20 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
},
["reload_empty_fast"] = {
{ ["time"] = 1 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
{ ["time"] = 5 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_out") },
{ ["time"] = 20 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.mag_in") },
{ ["time"] = 40 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gator.bolt_forward") },
},
--[FastExtMag]--
["reload_fast_extmag"] = {
{ ["time"] = 1 / 45, ["type"] = "sound", ["value"] = Sound("weapon_bo3_gear.rattle") },
...
SWEP.VElements = {
["default_barrel"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_barrel.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_bolt"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_bolt.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_grip"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_grip.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_clip"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_mag.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["sights_folded"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_sights.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_stock"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_stock.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
-- attachments
--sights
...
--other
["long_barrel"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_barrel.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["laser"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_dbal.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
...
["ext_clip"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_extmag.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["fast_mag"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_fastmag.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["grip"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_grip.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["rapidfire"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_bolt.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["stock"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_stock.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["suppressor"] = { type = "Model", model = "models/weapons/bo3/gator/attach/c_bo3_gator_suppressor.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
}
SWEP.WElements = {
["default_barrel"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_barrel.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_bolt"] = { type = "Model", model = "models/weapons/bo3/gator/base/c_bo3_gator_bolt.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
...
SWEP.AttachmentTableOverride	= {
	["bo3_ext_mag"] = {
		["LuaShellModel"] = "models/tfa/shotgunshell.mdl",
		["LuaShellScale"] = 0.4,
	},
	["bo3_long_barrel"] = {
		["ViewModelBoneMods"] = {
		...
		["Primary"] = {
			["RangeFalloffLUT"] = {
				...
				lut = {
					{range = 20, damage = 1.0},
					{range = 32, damage = 0.55},
					{range = 44, damage = 0.55},
					{range = 54, damage = 0.2},
				}
			},
		},
...
SWEP.AttachmentIconOverride     = {
	["bo3_long_barrel"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_extbarrel_01_rwd.png", "smooth"),
	["bo3_suppressor"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_suppressor_01_rwd.png", "smooth"),
	["bo3_ext_mag"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_extmag_01_rwd.png", "smooth"),
	["bo3_fast_mag"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_fastmag_01_rwd.png", "smooth"),
	["bo3_ub_laser"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_laser_01_rwd.png", "smooth"),
	["bo3_quickdraw"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_quickdraw_01_rwd.png", "smooth"),
	["bo3_stock"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_extstock_01_rwd.png", "smooth"),
	["bo3_rapidfire"] = Material("attachments/gator/t7_icon_attach_shotgun_semiauto_rapidfire_01_rwd.png", "smooth"),
}
