...
SWEP.PrintName				= "X-TRACKER (Scoped)"		-- Weapon name (Shown on HUD)
...
SWEP.NZRePaPText		= "tfa_cso_xtracker_nrm"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Razer Blackwidow Chroma"
...
--[[SWEP.IronAnimation = {
	...
	["shoot"] = {
		["type"] = TFA.Enum.ANIMATION_ACT, --Sequence or act
		["value"] = ACT_VM_HITLEFT, --Number for act, String/Number for sequence
		["transition"] = true
	}
}]]--
...
SWEP.TracerName 		= "tra_xtracker_sniper" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_xtracker")
