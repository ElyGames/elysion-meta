...
SWEP.PrintName				= "Dual Makarov PMs"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_tfap_dmaka.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dmaka.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_DMAKA.1")		-- Script that calls the primary fire sound
