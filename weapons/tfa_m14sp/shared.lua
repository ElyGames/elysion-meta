...
SWEP.Gun = ("tfa_m14sp") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_snip_m14sp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_snip_m14sp.mdl"	-- Weapon world model
