...
SWEP.PrintName				= "SKULL-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Skull1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .00375					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001875	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull1.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_skull1blood"} },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull1.mdl" -- same case UHGI;DFSD/
...
SWEP.RunSightsPos = Vector(0,-5,-4)
SWEP.RunSightsAng = Vector(42.5,0,0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull1")
