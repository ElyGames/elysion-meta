...
SWEP.PrintName				= "Cheytac Intervention M200"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M200.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 360					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m200.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m200.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/m200/m200_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(7.581, -4.824, 1.608)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m200")
