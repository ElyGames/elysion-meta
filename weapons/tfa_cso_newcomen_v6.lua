...
SWEP.PrintName				= "Newcomen Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("NewcomenV6.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 1800				-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_newcomen_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_newcomen_v6.mdl" -- Worldmodel path
...
function SWEP:Holster( ... )
	self:StopSound("NewcomenV6.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_newcomen_v6")
