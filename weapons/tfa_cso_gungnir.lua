...
SWEP.PrintName				= "Gungnir (True Form)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Gungnir.Shoot_1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 35000					-- Damage, in standard damage points.
SWEP.Primary.BlastRadius	= 650               -- Radius for DMG_BLAST
SWEP.DamageType = bit.bor(DMG_BLAST,DMG_ALWAYSGIB) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.AmmoConsumption = 5 --Ammo consumed per shot
SWEP.Primary.Automatic			= true					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 12					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 12					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_gungnir.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_gungnirb.mdl" -- Worldmodel path

SWEP.HoldType 				= "grenade"		-- This is how others view you carrying the weapon. Options include:
...
SWEP.TracerName 		= "tra_gungnir" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("Gungnir.Charge_loop")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_gungnir")
