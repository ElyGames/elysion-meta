...
SWEP.PrintName				= "Savery"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Savery.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sprifle.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_savery_violet" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_savery.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.092, -6.704, 1.996)
SWEP.IronSightsAng = Vector(5.372, 1.957, 0)
...
function SWEP:Holster( ... )
	self:StopSound("Savery.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_savery")
