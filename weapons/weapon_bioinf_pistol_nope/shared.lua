SWEP.Gun					= ("weapon_bioinf_pistol_nope") --Make sure this is unique.  Specically, your folder name.
...
--Firing related
SWEP.Primary.Sound 			= Sound("BIOINF_PISTOL.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/pistol/c_bioinf_pistol.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/pistol/w_bioinf_pistol.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(8.18, -4.007, -20)
SWEP.RunSightsAng = Vector(43.3, 9.722, 3.15)
...
SWEP.IronSightsPos = Vector(-6.148, -0.231, 0.978)
SWEP.IronSightsAng = Vector(-0.366, -0.225, 1.794)
...
SWEP.BlowbackBoneMods = {
	["Slide"] = { scale = Vector(1, 1, 1), pos = Vector(-3.294, -0.413, 0.3), angle = Angle(0, 0, 0) }
