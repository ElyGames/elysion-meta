...
SWEP.ViewModel				= "models/weapons/tfa_v_aw50_awp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_acc_int_aw50.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(3.68, -2.0, 1.08)
...
SWEP.ScopeOverlayTransformMultiplier = 0.6