...
SWEP.PrintName				= "Winchester M1887 - Master"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "World at War '87"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1887_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1887_master.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1887_master")
