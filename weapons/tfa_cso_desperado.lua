...
SWEP.PrintName = "Python Desperado" -- Weapon name (Shown on HUD)	
...
SWEP.Primary.DefaultClip = 213 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]
--
SWEP.ViewModel = "models/weapons/tfa_cso/c_desperados.mdl" --Viewmodel path
...
--[[WORLDMODEL]]
--
SWEP.WorldModel = "models/weapons/tfa_cso/w_desperado_man.mdl" -- Worldmodel path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_desperado_man")
