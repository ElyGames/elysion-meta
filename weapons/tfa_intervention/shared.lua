...
SWEP.ViewModel				= "models/weapons/tfa_v_snip_int.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_snip_int.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector (2.2263, -2.0007, 0.115)
SWEP.IronSightsAng = Vector (0, 0, 0)
SWEP.SightsPos = Vector (2.2263, -2.0007, 0.115)
...
SWEP.ScopeOverlayTransformMultiplier = 0.5
