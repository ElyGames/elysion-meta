...
SWEP.PrintName				= "Volcano"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM_Burst				= 300					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_volcano_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_volcano.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_volcano.mdl" -- Worldmodel path
