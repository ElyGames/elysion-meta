...
SWEP.PrintName				= "HSG-1 Shotgun NEON"		-- Weapon name (Shown on HUD)
...
SWEP.TracerName         = "muzzleflash_shotgun"   -- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_kf_neongun_hsg.mdl" --Viewmodel path
