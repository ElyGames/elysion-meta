...
SWEP.PrintName				= "SAKO TRG-42"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TRG42.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 42					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 42					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Saiko 420"
SWEP.NZPaPReplacement 	= "tfa_cso_trg42g"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.JumpAccuracyMultiplier=3.5--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_trg42.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_trg42.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/trg42/trg42_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(6.126, -4.073, 0.661)
SWEP.IronSightsAng = Vector(0.518, 0.513, -3.948)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_trg42")
