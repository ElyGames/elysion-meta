...
SWEP.PrintName				= "Fire Vulcan"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Burst				= 260					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_volcano"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_fire_vulcan.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_fire_vulcan.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fire_vulcan")
