...
SWEP.PrintName				= "MP7A1 60R"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MP7A160R.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZRePaPText		= "get a second MegaPulverizer"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "MegaPulverizer 14"
SWEP.NZPaPReplacement 	= "tfa_cso_dmp7a1"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.170				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.12					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.22				-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mp7a160r.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mp7a160r.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.425, -2.3, 1)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mp7a160r")
