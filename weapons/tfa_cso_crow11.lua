...
SWEP.PrintName				= "CROW-11"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW11.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow11.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_crow11memories" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow11.mdl" -- Worldmodel path
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		...
		{ time = 26 / 30, type = "lua", value = function(wep) wep:CrowEnableCheck() end},
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crow11")
