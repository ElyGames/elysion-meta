...
SWEP.PrintName				= "USAS-12 Camouflage"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Usas12.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 180					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "UR A** 20 rounds"
...
SWEP.Primary.Spread		= .046					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_usas12camo.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_usas12camo.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_usas12camo")
