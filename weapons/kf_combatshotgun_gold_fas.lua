...
SWEP.PrintName				= "Pompe du Maréchal"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--    
SWEP.Primary.Sound = Sound("weapons/tfa_cso/m3dragon/fire_1.ogg") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 110 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 18 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = false -- Automatic/Semi Auto
SWEP.Primary.RPM = 60 -- This is in Rounds Per Minute / RPM
SWEP.Primary.DamageType = DMG_BULLET -- Damage, in standard damage points.
 
-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "pack-a-punch again"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Dragon Breath"
--SWEP.NZPaPReplacement 	= "tfa_cso2_m3dragon"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Range Related
SWEP.Primary.Range = 200 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m3dragon.mdl" --Viewmodel path
...
SWEP.RunSightsPos = Vector(-1, -2, -1.5)
...
SWEP.IronSightsPos = Vector(4.28, 0, 2.299)
SWEP.IronSightsAng = Vector(-0.353, 0.446, 0)
--[[INSPECTION]]--
...
function SWEP:Deploy( ... )
	...
	timer.Simple(0, function()
		if IsValid(self) and self:VMIV() then
			self:CleanParticles()
			ParticleEffectAttach( "ss_m3dragon_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 2 )
			ParticleEffectAttach( "ss_m3dragon_fire_f", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 3 )
		end
	end)
	return true
end