...
SWEP.NZPaPReplacement 	= "tfa_cso_crossbowex"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crossbow.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crossbow.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.046, -1.688, 1.197)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crossbow")
