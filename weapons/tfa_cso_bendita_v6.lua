...
SWEP.PrintName				= "Bendita Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 720					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bendita_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bendita_v6.mdl" -- Worldmodel path
...
SWEP.Secondary.IronFOV			= 18					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bendita_v6")
