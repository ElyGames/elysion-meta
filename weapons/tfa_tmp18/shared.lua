...
SWEP.Gun = ("tfa_tmp18") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "TMP-18"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_haz_mat_wolf/c_tmp18.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_haz_mat_wolf/smg.mdl"	-- Weapon world model
SWEP.UseHands               = true
...
SWEP.Primary.Sound			= Sound("TFA_TMP181")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.716, -2.574, 0.977)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-1.716, -2.574, 0.977)
SWEP.SightsAng = Vector(0, 0, 0)
SWEP.RunSightsPos = Vector (3.371, -0.222, -1.109)
SWEP.RunSightsAng = Vector (-5.515, 13.336, 0.07)
