...
SWEP.PrintName				= "Thompson Chicago"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Typewriter"
SWEP.NZPaPReplacement 	= "tfa_cso_thompson_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.Spread		= .0072					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0036	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thompson_chicago.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_thompson_chicago.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thompson_chicago")
