...
SWEP.PrintName				= "Plasma Rifle MK-2"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PlasmaMK2.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 425					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 425					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_plasmagunexc"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.KickDown			= 0.07					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.15					-- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = 0.50 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ProjectileEntity = "plasmaexb" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_plasmaexb.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_plasmagunexb.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(7.95, -4.874, -1.44)
...
SWEP.MuzzleFlashEffect = "cso_muz_plasgunexab" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_plasmagunexb")
