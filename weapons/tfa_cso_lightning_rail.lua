...
SWEP.Primary.IronAccuracy = .00010	-- Ironsight accuracy, should be the same for shotguns
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_lightning_rail")
