...
SWEP.PrintName				= "Maréchal *Original*"		-- Weapon name (Shown on HUD)
...
SWEP.Type = "Ancien Maréchal"
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("KF_COMBSHOT") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("KF_COMBSHOT")-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SoundEchoTable = {
	[0] = Sound("KF_COMBSHOT"), -- Indoor
	[256] = Sound("KF_COMBSHOT") -- Outdoor
}
...
SWEP.Primary.NumShots = 6 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
SWEP.Primary.DefaultClip = SWEP.Primary.ClipSize * 9 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_kf_combgold.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-5, -4, 2)
SWEP.IronSightsAng = Vector(-0.2, -0.2, 0)
