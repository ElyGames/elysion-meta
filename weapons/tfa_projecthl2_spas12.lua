...
SWEP.Purpose				= "8 Gauge Shotgun" --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "Project HL2 Shotgun"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("Project_MMOD_Shotgun.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.NumShots = 13 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = false -- Automatic/Semi Auto
SWEP.Primary.RPM_Displayed =1600 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM = 1600 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi = nil -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Burst = 2500 -- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
SWEP.Primary.BurstDelay = nil -- Delay between bursts, leave nil to autocalculate
SWEP.Primary.DryFireDelay = 0
...
SWEP.DefaultFireMode = "burst" --Default to auto or whatev
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/c_IIopnshotgun.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_IIopnshotgun.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(5.427, -1.81, -0.805) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsAng = Vector(-4.926, 40.804, -2.112) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.302, -5.348, 2.071)
SWEP.IronSightsAng = Vector(0, 0, 0.688)
...
SWEP.MuzzleFlashEffect = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "mmod_muzzleflash_shotgun" or "tfa_muzzleflash_shotgun"
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD] = 15 / 61,
	[ACT_SHOTGUN_RELOAD_START] = 14 / 61,
}


SWEP.SequenceLengthOverride = {
    [ACT_SHOTGUN_RELOAD_FINISH] = 35 / 61,
}
