...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.SKS.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.SKS.2") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 83 -- Damage, in standard damage points.
...
--Recoil Related
SWEP.Primary.KickUp = 0.345 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0.315 -- This is the maximum downwards recoil (skeet)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_sks.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_sks.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV = 81 -- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
SWEP.IronSightsPos = Vector(-2.91, -2.5, 2.05)
SWEP.IronSightsAng = Vector(0.1, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.91, -2, 0.56)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 65

SWEP.IronSightsPos_EOTech = Vector(-2.91, -2, 0.57)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_EOTech = 76

SWEP.IronSightsPos_RDS = Vector(-2.91, -2, 0.57)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_RDS = 58

SWEP.IronSightsPos_2XRDS = Vector(-2.906, -2.5, 0.57)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 66

SWEP.IronSightsPos_C79 = Vector(-2.909, -1.5, 0.44)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 58

SWEP.IronSightsPos_PO4X = Vector(-2.845, 0, 0.91)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_PO4X = 53

SWEP.IronSightsPos_Mosin = Vector(-2.88, 2.5, 1.15)
...
SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_04.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["scope_mosin"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_mosin_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_ins.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_ins.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[7] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x", "ins2_si_mosin" }, order = 2 },
...
SWEP.ScopeOverlayTransforms_2XRDS = { -0.001, -0.333 }
SWEP.ScopeDistanceMin_2XRDS = 7.5
SWEP.ScopeDistanceRange_2XRDS = 8

SWEP.RTAttachment_C79 = 8
SWEP.ScopeOverlayTransforms_C79 = { 0, -0.336 }
SWEP.ScopeDistanceMin_C79 = 9
SWEP.ScopeDistanceRange_C79 = 12

SWEP.RTAttachment_PO4X = 8
SWEP.ScopeOverlayTransforms_PO4X = { -0.009, -0.28 }
SWEP.ScopeDistanceMin_PO4X = 9
SWEP.ScopeDistanceRange_PO4X = 11

SWEP.RTAttachment_Mosin = 8
SWEP.ScopeOverlayTransforms_Mosin = { -0.004, -0.242 }
SWEP.ScopeDistanceMin_Mosin = 10
SWEP.ScopeDistanceRange_Mosin = 12
