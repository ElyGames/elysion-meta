...
SWEP.PrintName				= "M4A1 Dark Knight Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage_Regular		= 142					-- Damage, in standard damage points.
...
SWEP.Primary.Damage_Secondary		= 285				-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 372				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_darkknight_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_darkknight_v8.mdl" -- I couldn't compile the Dark Knight's worldmodel either... why me
