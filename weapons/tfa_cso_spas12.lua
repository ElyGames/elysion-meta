...
SWEP.Primary.NumShots	= 15 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_spas12.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_spas12.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_spas12")
