...
SWEP.PrintName				= "Magnum Drill"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MagnumDrill.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "Hazdrill"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_magnumdrill_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 140				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnum_drill.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnum_drill.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.889, 0, 1.73)
SWEP.IronSightsAng = Vector(0.28, 0, 0)
...
SWEP.Blowback_Shell_Effect = "BuckShot"
...
SWEP.Secondary.BashDelay = 0.65
SWEP.Secondary.BashDamage = 1750
SWEP.Secondary.BashLength = 140

SWEP.Secondary.BashSound = Sound("MagnumDrill.Drill")
SWEP.Secondary.BashHitSound = Sound("Weapon_Knife.HitWall")
SWEP.Secondary.BashHitSound_Flesh = Sound("Weapon_Knife.Hit")
...
function SWEP:Holster( ... )
	self:StopSound("MagnumDrill.Idle")
	return BaseClass.Holster(self,...)
end

SWEP.Base				= "tfa_bash_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnumdrill")
