...
SWEP.PrintName				= "Bendita"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Bendita.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 480					-- Damage, in standard damage points.
SWEP.DamageType = bit.bor(DMG_BULLET,DMG_BURN) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= true					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 90					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 90					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= true	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "HOLY ASS 50"
SWEP.NZPaPReplacement 	= "tfa_cso_bendita_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bendita.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bendita.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.401, -3.283, 1.047)
SWEP.IronSightsAng = Vector(-3.586, 0.554, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bendita")
