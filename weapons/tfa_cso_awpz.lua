...
SWEP.PrintName				= "AWP-Z"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("AWPZ.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Tentache Hentai AWP"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_awpz.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_awpz.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.375, -7.973, -1.931)
SWEP.IronSightsAng = Vector(21.035, 2.96, -10.582)
...
function SWEP:Holster( ... )
	self:StopSound("AWPZ.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_awpz")
