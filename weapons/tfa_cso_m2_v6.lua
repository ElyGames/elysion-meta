...
SWEP.PrintName				= "M2 Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 475					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 475					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_m2_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 275					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 575				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m2_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m2_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m2_v6")
