...
SWEP.PrintName				= "QBS-09"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 17.5					-- Damage, in standard damage points.
...
SWEP.Primary.KickHorizontal			= 0.415					-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_qbs_09.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_qbs_09.mdl" -- Worldmodel path
...
SWEP.ShellTime			= .45 -- For shotguns, how long it takes to insert a shell.
...
SWEP.IronSightsPos = Vector(4.663, -4.4, 1.68)
SWEP.IronSightsAng = Vector(-1.048, 0.05, 1.4)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_qbs09")
