...
SWEP.Author				= "Global" --Author Tooltip
...
SWEP.PrintName				= "M95 White Tiger"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M95Tiger.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 1200					-- Damage, in standard damage points.
...
SWEP.Primary.RPM_Semi				= 40					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Secondary.Ent = "m95nuke"

SWEP.Secondary.Model = "models/weapons/tfa_cso/w_missile_v7.mdl" --Projectile Model
SWEP.Secondary.Damage = 600 --Grenade Damage
SWEP.Secondary.Velocity = 2000 --Grenade Velocity
SWEP.Secondary.Delay = 2 --Delay in seconds
SWEP.Secondary.Sound = Sound("M95Tiger.Fire2") --Firing sound
...
SWEP.NZPaPName				= "King of the Tundra"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95tiger.mdl" --Viewmodel path
...
SWEP.VElements = {
    ["eye"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tiger_root", rel = "", pos = Vector(0.1, 1.8, -2.8), angle = Angle(0, 200, 90), size = Vector(0.1, 0.1, 0.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m95_white_tiger_eye", skin = 0, bodygroup = {} }
}

SWEP.Attachments = {
    [1] = { atts = { "cso_m95tigerpaintiron" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95tiger.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(9.5, -0.02, 2.18)
SWEP.IronSightsAng = Vector(3.303, 2.483, 0)
...
SWEP.MuzzleFlashEffect = "cso_muz_m95tiger" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_m95tiger" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("M95Tiger.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95tiger")
