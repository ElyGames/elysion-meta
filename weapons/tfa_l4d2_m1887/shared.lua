...
SWEP.PrintName				= "MW3 M1887"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_L4D2_M1887.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .0395	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_mw3_m1887.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_mw3_m1887.mdl" -- Weapon world model path
...
SWEP.ShellTime			= 0.5125 -- For shotguns, how long it takes to insert a shell.
...
SWEP.IronSightsPos = Vector(-4.238, -5.498, 2.799)
