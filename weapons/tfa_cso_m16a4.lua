...
--Firing related
SWEP.Primary.Sound 			= Sound("M16A4.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 925					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 925					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "3-Burst"
...
SWEP.Primary.KickDown			= 0.135					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m16a4.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m16a4.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(9.27, -2, 2.2)
SWEP.IronSightsAng = Vector(1.5, 3.9, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m16a4")
