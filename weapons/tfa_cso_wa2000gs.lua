...
SWEP.PrintName				= "Walther WA2000 10th Anniversary"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "The Tsun Tsun Gun"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_wa2000gs.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_wa2000gs.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_wa2000gs")
