...
--Firing related
SWEP.Primary.Sound 			= Sound("PSG1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Better G3, Shit on Clipsize"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_psg1.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_psg1halloween" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_psg1.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.23, -0.033, 1.861)
SWEP.IronSightsAng = Vector(1.725, 0.765, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_psg1")
