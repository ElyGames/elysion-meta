...
SWEP.PrintName				= "SL8 Custom"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SL8EX.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 260					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Custom G36 Sniper Rifle"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sl8ex.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sl8ex.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/sl8/sl8ex_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(4.219, -2.115, 0.674)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sl8ex")
