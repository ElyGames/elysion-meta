...
SWEP.PrintName				= "AK-47 Gold"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Ak47.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "USSR Hardbass Anthem"
...
--Recoil Related
SWEP.Primary.KickUp			= 0.190				-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.140					-- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.Spread		= .0065					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00325	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g_ak47.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47g.mdl" -- Worldmodel path
...
SWEP.BlowbackBoneMods = {
	["bone52"] = { scale = Vector(1, 1, 1), pos = Vector(0, 3, -0.5), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_g_ak47")
