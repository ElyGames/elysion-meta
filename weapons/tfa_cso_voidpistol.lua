...
SWEP.PrintName				= "Void Avenger"		-- Weapon name (Shown on HUD)
...
SWEP.Secondary.Ent = "vulcanus7_missile"

SWEP.Secondary.Model = "models/weapons/tfa_cso/w_missile_v7.mdl" --Projectile Model
SWEP.Secondary.Damage = 400 --Grenade Damage
SWEP.Secondary.Velocity = 15000 --Grenade Velocity
SWEP.Secondary.Delay = 2.2 --Delay in seconds
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_voidpistol.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_vulcanus7.mdl" -- same case UHGI;DFSD/
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_vulcanus7")
