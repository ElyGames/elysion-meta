...
--Firing related
SWEP.Primary.Sound 			= Sound("P228.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 143				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_p228_v2")
