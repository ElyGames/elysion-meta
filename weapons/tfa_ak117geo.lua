...
SWEP.Author				= "Dorian15" --Author Tooltip
...
SWEP.PrintName				= "AK-117 Geometric"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("AK117.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("AK117.FireS") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 938 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.DefaultClip = 30 * 8 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_ak117geo.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0, 0.5, -0.3) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.ViewModelBoneMods = {
	["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(-0.08, 0, 0.74), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(1.35, 1.35, 1.35), pos = Vector(0, 0.6, 0.75), angle = Angle(0, 0, 0) },
	["A_Foregrips"] = { scale = Vector(0.2, 0.2, 0.2), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.IronSightsPos = Vector(-2.33, -2, -0.3)
SWEP.IronSightsAng = Vector(0.5, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.32, -2, -1.12)
SWEP.IronSightsAng_Kobra = Vector(0.5, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.32, -2, -1.35)
SWEP.IronSightsAng_EOTech = Vector(0.5, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.32, -2, -1.35)
SWEP.IronSightsAng_RDS = Vector(0.5, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.318, -2, -1.237)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 59

SWEP.IronSightsPos_C79 = Vector(-2.318, -2, -1.36)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 60

SWEP.IronSightsPos_PO4X = Vector(-2.255, -2, -0.898)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_PO4X = 60
...
SWEP.VElements = {
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrips", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.WElements = {
["ak"] = { type = "Model", model = "models/weapons/v_ak117geo.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.592, 0.837, -3.57), angle = Angle(-9.528, 0, 180), size = Vector(1.162, 1.162, 1.162), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.Attachments = {
	...
	[3] = {offset = { 0, 0 },atts = { "ins2_ub_laser" }, order = 4 },
	[4] = {offset = { 0, 0 },atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
