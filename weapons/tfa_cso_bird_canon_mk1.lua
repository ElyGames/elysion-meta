...
SWEP.PrintName				= "Gear Bird Cannon MK-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("BirdCanonMK1.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 800					-- Damage, in standard damage points.
...
SWEP.ProjectileEntity = "black_dragon_cannon_nade" --Entity to shoot
SWEP.ProjectileVelocity = 500 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_cannon_fireball.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_bird_canon_mk1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_black_dragon_cannon.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.719, -12, 1.159)
...
function SWEP:Holster( ... )
	self:StopSound("BirdCanonMK1.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dragoncannon")
