...
SWEP.PrintName				= "Triple-barreled shotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.NZPaPName				= "BEGONE THOT"
SWEP.NZPaPReplacement 	= "tfa_cso_qbarrel"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tbarrel.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tbarrel")
