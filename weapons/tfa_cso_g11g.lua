...
SWEP.PrintName				= "HK G11 Gold Edition"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM_Burst				= 2100					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "HK G22 Teller"
--SWEP.NZPaPReplacement 	= "tfa_cso_g11_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.StaticRecoilFactor = 0.225 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g11g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_g11g.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.928, -4.523, -0.76)
SWEP.IronSightsAng = Vector(0, 0, -3.454)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_g11g")
