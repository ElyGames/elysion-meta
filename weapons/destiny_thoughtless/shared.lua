...
SWEP.PrintName						= "Thoughtless"
SWEP.Type 							= "Sniper Rifle"
SWEP.FlavorText						= "Not a thought was given, but a life was taken."
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.HudIcon = "destiny_sniper"
SWEP.AmmoType = "Special"
...
SWEP.Primary.Sound 					= Sound ("TFA_THOUGHTLESS_FIRE.1")
SWEP.Primary.ReloadSound 			= Sound ("TFA_THOUGHTLESSM_RELOAD.1")
...
SWEP.ViewModel						= "models/weapons/Thoughtless/c_Thoughtless.mdl"
SWEP.WorldModel						= nil
...
SWEP.VElements = {
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "reticle", rel = "", pos = Vector(0, -.2, 0.7), angle = Angle(0, -90, 180), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0, type = "sound", value = Sound("TFA_THOUGHTLESS_DRAW.1")}
	}
}
...
SWEP.RTReticleMaterial = Material("models/thoughtless/thoughtlessReticle")
//SWEP.Compass = Material("models/1KStare/1KStareCompass")
SWEP.RTDot = Material("reticle/destiny2_reddot")
SWEP.RTReticleScale = 1.1
SWEP.RTDotScale = .05
SWEP.RTShadowScale = 2.1
...
SWEP.RTScopeFOV = 90 / 1.15 / 2 -- Default FOV / Scope Zoom / screenscale
