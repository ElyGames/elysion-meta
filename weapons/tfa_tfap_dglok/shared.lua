...
SWEP.Gun = ("tfa_tfap_dualelites")					-- must be the name of your swep
...
SWEP.PrintName				= "Dual Glock 17s"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_tfap_dglok.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dglok.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_DGLOK.1")		-- Script that calls the primary fire sound
...
SWEP.Callback.Initialize = function( self )
	self:SetMaterial("models/weapons/v_models/pist_glock18/Glock18black")
end
