...
SWEP.PrintName = "Auto 9" -- Weapon name (Shown on HUD)
...
SWEP.Primary.BurstDelay = 0.33 -- Delay between bursts, leave nil to autocalculate
...
SWEP.BlowbackBoneMods = {
	["Bone05"] = { scale = Vector(1, 1, 1), pos = Vector(0, 4.3, 0), angle = Angle(0, 0, 0) }
}
