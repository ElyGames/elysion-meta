...
SWEP.PrintName				= "M95 XMAS"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 1100					-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 58				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m95_xmas.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m95xmas.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m95_xmas")
