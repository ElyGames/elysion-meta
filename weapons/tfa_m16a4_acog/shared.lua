...
SWEP.Gun = ("tfa_m16a4_acog") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_M16_acog.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_dmg_m16ag.mdl"	-- Weapon world model
