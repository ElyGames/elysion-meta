...
SWEP.IronSightTime = 1 --The time to enter ironsights/exit it.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_xtracker_nrm.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(0, 2, 0)
