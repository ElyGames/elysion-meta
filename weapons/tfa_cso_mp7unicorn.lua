...
SWEP.PrintName				= "MP7A1 Unicorn"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Horsegun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "I Believe I Can Fly"
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mp7unicorn")
