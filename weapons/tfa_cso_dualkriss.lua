...
SWEP.PrintName				= "Dual Kriss"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Superb V"
SWEP.NZPaPReplacement 	= "tfa_cso_dualkrisshero"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualkriss.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dualkriss.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["dualkriss"] = { type = "Model", model = "models/weapons/tfa_cso/w_dualkriss.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(8.079, 1.292, 1.2), angle = Angle(0, 81.939, 9.534), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualkriss")
