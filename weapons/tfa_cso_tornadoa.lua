...
SWEP.PrintName				= "Tornado (No Charge)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Tornado.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "100%"
SWEP.NZPaPReplacement 	= "tfa_cso_tornadob"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tornado.mdl" --Viewmodel path
...
SWEP.TracerName 		= "cso_tra_tornado" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tornadoa")
