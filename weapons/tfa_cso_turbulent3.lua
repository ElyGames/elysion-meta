...
SWEP.PrintName				= "TURBULENT-3"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Turbulent3.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 152				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_turbulent3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_turbulent3.mdl" -- Worldmodel path
...
function SWEP:Holster( ... )
	self:StopSound("TURBULENT3.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_turbulent3")
