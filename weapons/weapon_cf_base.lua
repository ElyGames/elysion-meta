...
local swing,hitsnd,mins,maxs,punch,add = {"weapons/knife/knife_slash1.ogg","weapons/knife/knife_slash2.ogg"},{"weapons/knife/knife_hit1.ogg","weapons/knife/knife_hit2.ogg","weapons/knife/knife_hit3.ogg","weapons/knife/knife_hit4.ogg"},Vector(-10,-10,-10),Vector(10,10,10),Angle(0, 3, 0)
	...
	if tr.Hit then
		...
		if IsValid(ent) then
			...
			if (ent:IsPlayer() or ent:IsNPC() or ent.Type == "nextbot" or ent:GetClass() == "prop_ragdoll") then
				...
				self:EmitSound("weapons/knife/knife_hitwall1.ogg")
			end
