...
SWEP.PrintName				= "CHARGER-7"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CHARGER7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Spread		= .00575					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .02875	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_charger_7.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_charger_7.mdl" -- Worldmodel path
...
SWEP.Secondary.Damage = 200 --Damage
...
function SWEP:SecondaryAttack()
    ...
    self:SetNextSecondaryFire(CurTime() + 0.60)
    self.Idle = 0
...
function SWEP:PostPrimaryAttack()
	...
	if SERVER then
		if self.NextGen >= 10 and self:Ammo2() < 20 then
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_charger7")
