...
SWEP.PrintName				= "SKULL-5"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Skull5.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 134				-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 264				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull5.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_skull5blood"} },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull5.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.737, -2.671, 1.391)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull5")
