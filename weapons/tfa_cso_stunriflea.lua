...
SWEP.PrintName				= "Stun Rifle (No Charge)"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_stunrifleb"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stunriflea.mdl" --Viewmodel path
...
function SWEP:Holster( ... )
	self:StopSound("Stunrifle.IdleA")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stunriflea")
