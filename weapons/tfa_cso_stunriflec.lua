...
SWEP.PrintName				= "Stun Rifle (Fully Charged)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Stunrifle.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stunriflec.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_stunrifle.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_stunrifle" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "tra_stunrifle" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Holster( ... )
	self:StopSound("Stunrifle.IdleC")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stunriflec")
