...
SWEP.PrintName				= "Newcomen"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Newcomen.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 1600				-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Rickland"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_newcomen.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_newcomen.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.538, -1.1, -1.55)
SWEP.IronSightsAng = Vector(3.2, 0.385, -2.1)
...
SWEP.BlowbackVector = Vector(-0.018,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
function SWEP:Holster( ... )
	self:StopSound("Newcomen.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_newcomen")
