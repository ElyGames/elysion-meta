...
SWEP.PrintName				= "Dual Kriss Custom"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("KrissHero.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 0.18 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.

--Firing Cone Related

SWEP.Primary.Spread		= .0064					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualkrisshero.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dualkrisshero.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["dualkriss"] = { type = "Model", model = "models/weapons/tfa_cso/w_dualkrisshero.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(8.079, 1.292, 1.2), angle = Angle(0, 81.939, 9.534), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.RunSightsAng = Vector(-35.562, 0, 0)
