...
SWEP.Gun = ("tfa_fal") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_fnfalnato.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_fn_fal.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(-3.142, -1.5, 1.28)
