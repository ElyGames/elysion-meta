...
SWEP.PrintName				= "Hunter Killer X-12"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("X-12.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 220					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Automatico-12"
--SWEP.NZPaPReplacement 	= "tfa_cso_usas12camo"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 210				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.StaticRecoilFactor = 0.28 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_x-12.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_x-12.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/hunter_killer/hunter_killer_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(5.245, -4.165, 0.019)
SWEP.IronSightsAng = Vector(2.944, 0.903, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_x-12")
