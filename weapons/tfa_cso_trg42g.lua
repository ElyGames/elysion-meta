...
SWEP.PrintName				= "SAKO TRG-42 White Gold"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 170					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_trg42g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_trg42g.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_trg42g")
