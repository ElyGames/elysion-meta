...
function SWEP:Precache()
    ...
    util.PrecacheSound("dogswep/attack_hit_1.ogg")
    util.PrecacheSound("dogswep/attack_hit_2.ogg")
    util.PrecacheSound("dogswep/attack_hit_3.ogg")
    util.PrecacheSound("dogswep/attack_hit_4.ogg")
    util.PrecacheSound("dogswep/bdog_attack_1.ogg")
    util.PrecacheSound("dogswep/bdog_attack_2.ogg")
    util.PrecacheSound("dogswep/bdog_attack_3.ogg")
    util.PrecacheSound("dogswep/bdog_attack_4.ogg")
    util.PrecacheSound("dogswep/bdog_die_2.ogg")               -- WARNING! Here are the sounds. You need to change them if you want to use other sounds.
    util.PrecacheSound("dogswep/bdog_die_3.ogg")
    util.PrecacheSound("dogswep/bdog_eat_1.ogg")
    util.PrecacheSound("dogswep/bdog_groan_1.ogg")
    util.PrecacheSound("dogswep/bdog_hurt_1.ogg")
    util.PrecacheSound("dogswep/bdog_hurt_2.ogg")
    util.PrecacheSound("dogswep/bdog_idle_1.ogg")
    util.PrecacheSound("dogswep/bdog_idle_2.ogg")
    util.PrecacheSound("dogswep/bdog_idle_3.ogg")
    util.PrecacheSound("dogswep/bdog_idle_4.ogg")
    util.PrecacheSound("dogswep/bdog_panic_1.ogg")
    util.PrecacheSound("dogswep/bdog_panic_2.ogg")
end
...
function SWEP:Think()
    ...
    if trace.Hit then
        pl:EmitSound("npc/zombie/claw_strike"..math.random(1, 3)..".ogg")   ---------------------- WARNING! Here you can set up swinging sounds of the weapon
    end

    pl:EmitSound("npc/zombie/claw_miss"..math.random(1, 2)..".ogg")   ---------------------------- WARNING! Here you can set up missing sounds of the weapon
    self.PreHit = nil
...
function SWEP:PrimaryAttack()
    ...
    self.Owner:EmitSound("dogswep/attack_hit_"..math.random(1, 4)..".ogg") ----------------------------- WARNING! Here you can change the sounds playing with left mouse button
...
function SWEP:SecondaryAttack()
    ...
    if SERVER and not CLIENT then
        self.Owner:EmitSound("dogswep/bdog_attack_"..math.random(1, 4)..".ogg") -- WARNING! Here you can change the sounds playing with right mouse button
    end
...
function SWEP:Reload()
    ...
    if SERVER and not CLIENT then
        self.Owner:EmitSound("dogswep/bdog_idle_"..math.random(1, 3)..".ogg") -- WARNING! Here you can change the sounds playing with reload button
    end
