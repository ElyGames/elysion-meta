local soundData = {
	name 		= "M3Dragon.ReloadInsert" ,
	channel 	= CHAN_WEAPON,
	volume 		= 1,
	soundlevel 	= 80,
	pitchstart 	= 100,
	pitchend 	= 100,
	sound 		= "weapons/tfa_cso/m3dragon/reload_insert.ogg"
}

sound.Add(soundData)

local soundData = {
	name 		= "M3Dragon.ReloadFinish" ,
	channel 	= CHAN_WEAPON,
	volume 		= 1,
	soundlevel 	= 80,
	pitchstart 	= 100,
	pitchend 	= 100,
	sound 		= "weapons/tfa_cso/m3dragon/reload_finish.ogg"
}

sound.Add(soundData)

local soundData = {
	name 		= "M3Dragon.Shoot1" ,
	channel 	= CHAN_USER_BASE+11,
	volume 		= 1,
	soundlevel 	= 80,
	pitchstart 	= 100,
	pitchend 	= 100,
	sound 		= "weapons/tfa_cso/m3dragon/fire_1.ogg"
}

sound.Add(soundData)

local soundData = {
	name 		= "M3Dragon.Shoot2" ,
	channel 	= CHAN_USER_BASE+11,
	volume 		= 1,
	soundlevel 	= 80,
	pitchstart 	= 100,
	pitchend 	= 100,
	sound 		= "weapons/tfa_cso/m3dragon/fire_2.ogg"
}
...
SWEP.PrintName				= "M3 Black Dragon"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M3Dragon.Shoot1")	-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 350					-- Damage, in standard damage points.
SWEP.DamageType = /*bit.bor(DMG_BULLET,DMG_AIRBOAT,DMG_BLAST,DMG_ALWAYSGIB)*/ DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.NZPaPName				= "Dragon Hellfire"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m3_dragon.mdl" --Viewmodel path
...
SWEP.VElements = {
	["flame_right"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "m3_dragon", rel = "", pos = Vector(20.917, 4.296, -3.639), angle = Angle(0, 90, -90), size = Vector(0.25, 0.25, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/tfa_cso/m3_dragon/m3_flame_right", skin = 0, bodygroup = {} },
	["flame_left"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "m3_dragon", rel = "", pos = Vector(20.917, 4.296, 3.638), angle = Angle(0, 90, -90), size = Vector(0.25, 0.25, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/tfa_cso/m3_dragon/m3_flame_left", skin = 0, bodygroup = {} }
}

SWEP.Attachments = {
    [1] = { atts = { "cso_m3dragonpaintwood" } },
}
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m3_dragon.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_blk_drg" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_blk_drg" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m3dragon")
