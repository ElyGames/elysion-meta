...
SWEP.NZPaPName			= "Six-Barrel Terror"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.DefaultFireMode 	= "Semi" --Default to auto or whatever
SWEP.FireModes = {"Semi","4Burst"}

--Ammo Related

SWEP.Primary.ClipSize			= 4					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 84				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Secondary.IronFOV			= 67					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(4.519, 0, 3.079)
SWEP.IronSightsAng = Vector(0.767, -0.21, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_qbarrel")
