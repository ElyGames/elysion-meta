...
SWEP.PrintName				= "Tornado (Fully Charged)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Tornado.Fire3")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tornado_c.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(6.897, -8.681, -1.195)
...
SWEP.TracerName 		= "cso_tra_tornado_c" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tornadoc")
