...
SWEP.PrintName				= "TURBULENT-7"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TURBULENT7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "TURBO-BLAZED-14"
...
SWEP.Primary.Spread		= .0070					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_turbulent_7.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_turbulent_7.mdl" -- Worldmodel path
...
function SWEP:Holster( ... )
	self:StopSound("TURBULENT7.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_turbulent7")
