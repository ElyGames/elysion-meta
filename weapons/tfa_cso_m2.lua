...
SWEP.PrintName				= "M2"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M2.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Big Fucking Gun"
SWEP.NZPaPReplacement 	= "tfa_cso_m2_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 550				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.40 				-- This is the maximum upwards recoil (rise)
...
SWEP.Primary.Spread		= .00625					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .003125	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m2.mdl" -- Worldmodel path
...
SWEP.TracerName 		= "tfa_tracer_incendiary" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m2")
