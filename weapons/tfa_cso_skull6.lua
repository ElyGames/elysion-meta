...
SWEP.PrintName				= "SKULL-6"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SKULL6.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown			= 0.090					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull_6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull_6.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.3, -2.603, 1.2)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull6")
