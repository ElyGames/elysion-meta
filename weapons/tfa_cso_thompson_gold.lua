...
SWEP.PrintName				= "Thompson - Gold"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Mafia Typewriter"
...
SWEP.Primary.KickDown			= 0.115					-- This is the maximum downwards recoil (skeet)
...
SWEP.MoveSpeed = 1.09 --Multiply the player's movespeed by this.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thompson_gold.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_thompson_gold.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thompson_gold")
