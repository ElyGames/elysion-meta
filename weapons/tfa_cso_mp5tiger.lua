...
SWEP.PrintName				= "MP5 White Tiger"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Tiger's Heavy Machine Gun"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mp5tiger.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mp5tiger.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mp5tiger")
