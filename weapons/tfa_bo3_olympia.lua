...
SWEP.Purpose = "Double-barrel over/under shotgun. Effective at medium to close range."
...
--[Model]--
SWEP.ViewModel			= "models/weapons/bo3/olympia/base/c_bo3_olympia.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/bo3/olympia/base/w_bo3_olympia.mdl"
SWEP.HoldType = "ar2"
...
SWEP.IronSightsPos = Vector(-4.4, -2, 1.2)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.IronSightsPos_ELO = Vector(-4.405, -2, -0.025)
SWEP.IronSightsAng_ELO = Vector(0, 0, 0)
SWEP.IronSightsPos_REFLEX = Vector(-4.41, -2, -0.025)
SWEP.IronSightsAng_REFLEX = Vector(0, 0, 0)
SWEP.IronSightsPos_BOA3 = Vector(-4.41, -2, 0.05)
...
SWEP.VElements = {
["default_barrel"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_barrel.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_fast_mag"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_fastmag.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_bolt"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_bolt.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_grip"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_grip.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["rail_sights"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_rail_sights.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["default_pip_sight"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_sight_pip.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
["default_stock"] = { type = "Model", model = "models/weapons/bo3/olympia/base/c_bo3_olympia_stock.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = true, bodygroup = {} },
-- attachments
--sights
...
--other
["long_barrel"] = { type = "Model", model = "models/weapons/bo3/olympia/attach/c_bo3_olympia_barrel.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
...
["fast_mag"] = { type = "Model", model = "models/weapons/bo3/olympia/attach/c_bo3_olympia_fastmag.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["grip"] = { type = "Model", model = "models/weapons/bo3/olympia/attach/c_bo3_olympia_grip.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["rapidfire"] = { type = "Model", model = "models/weapons/bo3/olympia/attach/c_bo3_olympia_bolt.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
["stock"] = { type = "Model", model = "models/weapons/bo3/olympia/attach/c_bo3_olympia_stock.mdl", bone = "tag_weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
...
SWEP.AttachmentIconOverride     = {
	["bo3_long_barrel"] = Material("attachments/olympia/t7_icon_attach_shotgun_olympia_extbarrel_01_rwd.png", "smooth"),
