...
SWEP.PrintName				= "Dual P220s"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_tfap_dp220.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_tfap_dp220.mdl"	-- Weapon world model
