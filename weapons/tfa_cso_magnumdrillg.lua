...
SWEP.PrintName				= "Magnum Drill Gold"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnumdrillg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnumdrillg.mdl" -- Worldmodel path
...
SWEP.Secondary.BashDamage = 2750
...
SWEP.Base				= "tfa_bash_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnumdrillg")
