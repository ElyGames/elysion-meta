...
SWEP.PrintName				= "Rail Buster"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("RailBuster.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_rail_buster.mdl" --Viewmodel path
