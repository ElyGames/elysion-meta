...
SWEP.PrintName				= "Brick Piece V2 (A Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("BrickPieceV2.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "Step' on me"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_v2rocket"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.StaticRecoilFactor = 0.325 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_brick_piece_v2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_brick_piece_v2.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.73, -3, 0.23)
SWEP.IronSightsAng = Vector(3.186, -0.141, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_brickpiecev2")
