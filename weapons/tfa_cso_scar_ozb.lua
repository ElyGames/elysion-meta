...
SWEP.PrintName				= "SCAR OZ-B"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ScarB.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "OOF-100"
SWEP.NZPaPReplacement 	= "tfa_cso_scar_ozc"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.Spread		= .00475					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .002375	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scar_ozb.mdl" --Viewmodel path
...
SWEP.VMPos = Vector(0,0,0.75) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scar_ozb.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(10.508, -6.388, 3.512)
SWEP.IronSightsAng = Vector(-1.897, 0.112, 5.127)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ozscarb")
