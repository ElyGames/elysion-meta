...
SWEP.PrintName				= "Bouncer"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Bouncer.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.MaxPenetrationCounter=8 --The maximum number of ricochets.  To prevent stack overflows.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bouncer.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bouncer.mdl" -- Worldmodel path
...
SWEP.TracerName 		= "cso_tra_bouncer" 	--Change to a string of your tracer name.  Can be custom.
