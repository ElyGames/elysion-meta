...
--Firing related
SWEP.Primary.Sound 			= Sound("MOSIN.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mosin.mdl" --Viewmodel path
...
SWEP.Attachments = {
    --[1] = { atts = { "cso_mosinelegant" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_mosin.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.237, -3.501, 2.538)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mosin")
