...
SWEP.Primary.Spread		= .0033					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00165	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.VElements = {
    ["smoke"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "buffaug_root", rel = "", pos = Vector(6.217, 2.496, 0), angle = Angle(0, -180, 90), size = Vector(0.2, 0.2, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/aug_guardian_smoke", skin = 0, bodygroup = {} }
}
...
SWEP.ScopeScale = 0.9 --Scale of the scope overlay
...
SWEP.IronSightsPos = Vector(11.871, -3.783, 1.868)
SWEP.IronSightsAng = Vector(0, 10.109, -2.018)
