...
if TFA then
	...
	TFA.AddFireSound(pref .. ".1", path .. "shoot_unsil.ogg", false, ")")
	TFA.AddFireSound(pref .. ".2", path .. "shoot.ogg", false, ")")

	TFA.AddWeaponSound(pref .. ".Empty", path .. "handling/l85a2_empty.ogg")
	TFA.AddWeaponSound(pref .. ".Boltback", path .. "handling/l85a2_boltback.ogg")
	TFA.AddWeaponSound(pref .. ".Boltrelease", path .. "handling/l85a2_boltrelease.ogg")
	TFA.AddWeaponSound(pref .. ".Magrelease", path .. "handling/l85a2_maghitrelease.ogg")
	TFA.AddWeaponSound(pref .. ".Magout", path .. "handling/l85a2_magout.ogg")
	TFA.AddWeaponSound(pref .. ".Magin", path .. "handling/l85a2_magin.ogg")
	TFA.AddWeaponSound(pref .. ".Hit", path .. "handling/l85a2_hit.ogg")
	TFA.AddWeaponSound(pref .. ".Rattle", path .. "handling/l85a2_rattle.ogg")
	TFA.AddWeaponSound(pref .. ".ROF", path .. "handling/l85a2_fireselect.ogg")
end
