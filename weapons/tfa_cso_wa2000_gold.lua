...
SWEP.PrintName				= "Walther WA2000 - Gold"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 130					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 130					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "The Blast Falcon - Gold"
...
--Recoil Related
SWEP.Primary.KickUp			= 0.4375					-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.3875					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_wa2000_gold.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_wa2000_gold.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_wa2000_gold")
