...
SWEP.PrintName				= "Falcon"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Falcon.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown			= 0.65					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_falcon.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_falcon.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_falcon")
