...
SWEP.Author				= "Hidden & Raven"
SWEP.Contact				= ""
SWEP.Purpose				= "Make sure your teammates revive you because you have a raygun.  Other than that shoot zombies... Simple"
SWEP.Instructions				= ""
...
SWEP.Primary.Sound			= Sound("raygun_fire.ogg")		-- Script that calls the primary fire sound
...
function SWEP:PreDrawViewModel( vm )
	if self.Ispackapunched == 1 then
		...
		vm:SetSubMaterial(3, "models/weapons/wavegun/_-gzombie_teleporter_glow_c.vmt")
	else
...
SWEP.Primary.Ammo			= "Battery"			-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
...
SWEP.Primary.Damage		= 185	-- Base damage per bullet
...
if !self:CanPrimaryAttack() then return end
	...
	self.Weapon:EmitSound("raygun_fire.ogg")
