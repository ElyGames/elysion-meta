...
sound.Add({
	...
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/charge_start.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Charge_Idle1",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/charge_idle1.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Charge_Idle2",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/charge_idle2.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Charge_Finish",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/charge_finish.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Draw",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/draw.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.ChargeAttack2",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/charge_attack2.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.SlashEnd",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/slash_end.ogg" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Slash1",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/magicknife/slash1.ogg"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Slash2",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/magicknife/slash2.ogg"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Slash3",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/magicknife/slash3.ogg"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.Slash4",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/magicknife/slash4.ogg"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.HitFleshSlash",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/hit.ogg"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "PrismSword.HitWall",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/magicknife/wall.ogg" },
	['pitch'] = {100,100}
})
