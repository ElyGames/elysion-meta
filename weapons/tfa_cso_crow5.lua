...
SWEP.PrintName				= "CROW-5"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW5.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "SCAVENGER-10"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow5.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow5.mdl" -- Worldmodel path
...
SWEP.ReticleScale = 0.6 --Scale of the reticle overlay
...
SWEP.IronSightsPos = Vector(7.05, -8.898, 0.234)
SWEP.IronSightsAng = Vector(0.475, 6.38, -3.751)
...
SWEP.BlowbackVector = Vector(-0.285,-2.5,0.032) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.BlowbackBoneMods = {
	["reloader"] = { scale = Vector(1, 1, 1), pos = Vector(-0.35, 1.25, -5), angle = Angle(0, 0, 0) },
}
