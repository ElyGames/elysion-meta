...
SWEP.PrintName				= "SPAS-12 Maverick"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SPAS12Maverick.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "SPAS-24 Craft"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_spas12maverick.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_spas12maverick.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_spas12maverick")
