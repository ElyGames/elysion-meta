...
SWEP.Gun = ("tfa_f2000") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_tct_f2000.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_fn_f2000.mdl"	-- Weapon world model
