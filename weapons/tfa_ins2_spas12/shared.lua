...
SWEP.Manufacturer = "Franchi" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_SPAS12.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_SPAS12.2") -- This is the sound of the weapon, when silenced.
...
--Miscelaneous Sounds
SWEP.IronInSound = Sound("TFA_INS2_SPAS12.IronIn") --Sound to play when ironsighting in?  nil for default
SWEP.IronOutSound = Sound("TFA_INS2_SPAS12.IronOut") --Sound to play when ironsighting out?  nil for default
--Silencing
...
SWEP.Primary.DefaultClip = 81 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_spas12_bri.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_spas12_bri.mdl" -- Weapon world model path
...
SWEP.IronAnimation = {
	["shoot"] = {
		...
		["value"] = ACT_VM_PRIMARYATTACK_DEPLOYED, --Number for act, String/Number for sequence
		["value_last"] = ACT_VM_PRIMARYATTACK_DEPLOYED_1,
		["value_empty"] = ACT_VM_PRIMARYATTACK_DEPLOYED_EMPTY
	} --What do you think
}
...
SWEP.PumpAction = {
	...
	["value_is"] = ACT_VM_PRIMARYATTACK_DEPLOYED_2
}
--[[EFFECTS]]--
--Attachments
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 20 / 35, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/c_spas12_bri_supp.mdl", bone = "Weapon", rel = "", pos = Vector(2.046, -8.794, 2.657), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
SWEP.WElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_sec2.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false }
}
SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "ins2_br_supp" }, order = 1 },
	[2] = { offset = { 0, 0 }, atts = { "sg_frag","sg_slug" }, order = 2 }
