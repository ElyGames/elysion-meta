...
SWEP.PrintName				= "Thompson - Master"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Chicago Favorite"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thompson_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_thompson_master.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thompson_master")
