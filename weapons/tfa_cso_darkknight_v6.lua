...
SWEP.PrintName				= "M4A1 Shadow Knight"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage_Regular		= 95					-- Damage, in standard damage points.
...
SWEP.Primary.Damage_Secondary		= 190				-- Damage, in standard damage points.
...
SWEP.IronSightTime = 0.01 --The time to enter ironsights/exit it.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dark_knight_overlord.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dark_knight_overlord.mdl" -- I couldn't compile the Dark Knight's worldmodel either... why me
...
SWEP.IronSightsReloadEnabled = true -- Enable ADS reload animations support (requires animations to be enabled in SWEP.Animations)

SWEP.Sights_Mode = TFA.Enum.LOCOMOTION_ANI -- LOCOMOTION_ANI = mdl, LOCOMOTION_HYBRID = ani + lua, LOCOMOTION_LUA = lua only
SWEP.IronAnimation = {
    ["loop"] = {
        ["type"] = TFA.Enum.ANIMATION_SEQ, -- Sequence or act
        ["value"] = "idle1", -- Number for act, String/Number for sequence
    } -- Looping Animation
}
...
SWEP.MuzzleFlashEffect = "cso_muz_dkn_ol" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_dkn_ol" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_darkknight_v6")
