...
SWEP.Purpose				= "Lock, Load and fire with this Highly Explosive flechette sniper rifle." --Purpose Tooltip
...
SWEP.Primary.RPM_Displayed = 60 -- This is in Rounds Per Minute / RPM
...
function SWEP:OnPaP()
	...
	if surface then
		self.Secondary.ScopeTable =
			{
				scopetex = surface.GetTextureID("models/weapons/scavenger/scope_overlay_scavenger2"),
...
--Recoil Related
SWEP.Primary.KickUp            = 0.78                -- This is the maximum upwards recoil (rise)
...
SWEP.WalkAccuracyMultiplier= 2.35 --Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.ProjectileModel = "models/weapons/scavenger/scavenger_projectile.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/scavenger/v_scavenger.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/scavenger/w_scavenger.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-4.18, -1.81, 0.70)
