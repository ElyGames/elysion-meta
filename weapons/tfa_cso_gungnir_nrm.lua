...
SWEP.Instructions				= "Use with precaution" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "Gungnir"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.PenetrationMultiplier	= 10
SWEP.Primary.HullSize = 5

--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("Gungnir.Shoot_Loop")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 500					-- Damage, in standard damage points.
SWEP.DamageType = bit.bor (DMG_BULLET,DMG_DISSOLVE,DMG_AIRBOAT) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.Primary.HullSize = 1.5 --Big bullets, increase this value.  They increase the hull size of the hitscan bullets


-- nZombies Stuff
SWEP.NZWonderWeapon		= true	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Overpowered Trident"
...
SWEP.JumpRecoilMultiplier=1  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
SWEP.WallRecoilMultiplier=1  --Multiply recoil by this factor when we're changing state e.g. not completely ironsighted.  This is proportional, not inversely.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_gungnir_nrm.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_gungnir_sigma"} },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_gungnira.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.532, -3.852, 1.84)
...
SWEP.TracerName 		= "tra_gungnir_nrm" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Primary.ImpactEffect = "exp_gungnir"
--[[EVENT TABLE]]--
...
SWEP.Secondary.Ent = "gungnir_alt"
SWEP.Secondary.Automatic			= true					-- Automatic/Semi Auto
SWEP.Secondary.Model = "models/items/ar2_grenade.mdl" --Projectile Model
SWEP.Secondary.Damage = 1250 --Grenade Damage
SWEP.Secondary.Velocity = 2500 --Grenade Velocity
SWEP.Secondary.Delay = 0.7 --Delay in seconds
SWEP.Secondary.Sound = Sound("Gungnir.Shoot_B") --Firing sound
...
function SWEP:Holster( ... )
	self:StopSound("Gungnir.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_gungnir_nrm")
