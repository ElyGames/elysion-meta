...
SWEP.Gun = ("tfa_l85") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_rif_l85.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_l85a2.mdl"	-- Weapon world model
