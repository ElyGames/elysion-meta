...
SWEP.PrintName				= "Burning AUG"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("BurningAUG.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 35					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BURN --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.Secondary.Model = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Projectile Model
SWEP.Secondary.Damage = 480 --Grenade Damage
SWEP.Secondary.Velocity = 2000 --Grenade Velocity
SWEP.Secondary.Delay = 2.75 --Delay in seconds
SWEP.Secondary.Sound = Sound("BurningAUG.FireNade") --Firing sound
SWEP.Secondary.Recoil = Angle(-5,1,0) --Recoil Dir
...
SWEP.Primary.StaticRecoilFactor = 0.275 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_burning_aug.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_burning_aug.mdl" -- same case UHGI;DFSD/
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_burningaug")
