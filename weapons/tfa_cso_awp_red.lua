...
SWEP.PrintName				= "AWP Red"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_awp_red.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_awpxmas.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_awp_red")
