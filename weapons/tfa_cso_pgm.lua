...
SWEP.PrintName				= "PGM Hécate II"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PGM.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 230					-- Damage, in standard damage points.
...
SWEP.Primary.RPM_Semi				= 35					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Anti-AWP"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_pgm.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_pgmbattle" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_pgm.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.091, -4.145, -0.334)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_pgm")
