...
--Firing related
SWEP.Primary.Sound 			= Sound("NGNegev.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "$2000 Laserpointer"
...
--Recoil Related
SWEP.Primary.KickUp			= 0.185					-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_negev.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_negevbattle"} },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_negev.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.077, -0.7, 0.85)
SWEP.IronSightsAng = Vector(1.475, 1.63, -1.2)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_negev")
