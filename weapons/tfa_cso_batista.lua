...
SWEP.PrintName				= "Batista"		-- Weapon name (Shown on HUD)
SWEP.NZPaPName				= "Zaldívar"			-- For nZombies. Pack-a-punch this gun to get this name!
...
SWEP.NZPaPName			= "Gwendolyn"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.Primary.DefaultClip			= 34				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_batista.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_batista.mdl" -- Worldmodel path
