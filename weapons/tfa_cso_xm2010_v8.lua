...
SWEP.PrintName				= "Remington XM2010 ESR Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 175					-- Damage, in standard damage points.
...
SWEP.Primary.DefaultClip			= 98				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_xm2010_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_xm2010_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_xm2010_v8")
