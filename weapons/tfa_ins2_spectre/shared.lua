...
SWEP.Manufacturer = "SITES" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "Spectre M4"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_SPECTRE.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_SPECTRE.2") -- This is the sound of the weapon, when silenced.
...
--Ammo Related
SWEP.Primary.ClipSize = 34 -- This is the size of a clip
...
--Recoil Related
SWEP.Primary.KickUp = 0.225 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_spectre.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_spectre.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.052, -2, 1.05)
SWEP.IronSightsAng = Vector(0.1, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.052, -4, -0.112)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.052, -4, -0.102)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.052, -4, -0.104)
SWEP.IronSightsAng_RDS = Vector(0.01, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.052, -4, -0.09)
SWEP.IronSightsAng_2XRDS = Vector(0.01, 0, 0)
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD] = 105 / 60,
	[ACT_VM_RELOAD_EMPTY] = 105 / 60,
} --Changes the status delay of a given animation; only used on reloads.  Otherwise, use SequenceLengthOverride or one of the others
SWEP.SequenceLengthOverride = {
	[ACT_VM_RELOAD] = 175 / 60,
	[ACT_VM_RELOAD_EMPTY] = 250 / 60
...
SWEP.ViewModelBoneMods = {
	...
	["A_Underbarrel"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_Modkit"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_Optic"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, .22, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, -.4), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(.75, .75, .75), pos = Vector(-1, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(1, 1, 1), pos = Vector(-1, 0.08, 0.38), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-2.5, -0.75, -0.1), angle = Angle(0, 0, -90) },
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_spectre_stockfolded.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_spectre_modkit.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0, 0, 0), angle = Angle(0, -2, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}
SWEP.WElements = {
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum" }, order = 4 },
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds" }, order = 2 },
...
SWEP.ScopeOverlayTransforms_2XRDS = { -0.00,-0.31 }
SWEP.ScopeDistanceMin_2XRDS = 9
SWEP.ScopeDistanceRange_2XRDS = 12
SWEP.RTScopeFOV_2XRDS = 39 -- fov_wpn_ironsight
SWEP.Secondary.IronFOV_2XRDS = 56 -- fov_wpn_focus
