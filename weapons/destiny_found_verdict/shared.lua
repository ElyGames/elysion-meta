...
SWEP.Primary.RPM_Semi				= 55
SWEP.Primary.Delay				    = 0
SWEP.Primary.Sound 					= Sound ("TFA_FOUNDV_FIRE.1")
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = { -- providing zero point is not required
		...
		{range = 5, damage = 1},
		{range = 12, damage = 0.60},
		{range = 14, damage = 0.40},
		{range = 16, damage = 0.30},
		{range = 18, damage = 0.20},
		{range = 20, damage = 0.10},
		{range = 22, damage = 0.05},
		{range = 24, damage = .02},
		{range = 26, damage = 0},
	}
}
...
SWEP.ViewModel						= "models/weapons/FoundVerdict/c_found_verdict.mdl"
SWEP.WorldModel						= nil
...
SWEP.IronSightsPos = Vector(-5.34, -6, .75)
...
SWEP.VMAng = Vector(.5, .5, -.5) -- The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{["time"] = 0, type = "sound", value = Sound("TFA_FOUNDV_SHELL.1")},
	},
	[ACT_SHOTGUN_RELOAD_START] = {
		//{ ["time"] = 0, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{["time"] = 0, type = "sound", value = Sound("TFA_FOUNDV_RELOADSTART.1")}
	},
	[ACT_SHOTGUN_RELOAD_FINISH] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = .2, type = "sound", value = Sound("TFA_FOUNDV_PUMP.1")}
	},
	[ACT_VM_PRIMARYATTACK] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = .33, type = "sound", value = Sound("TFA_FOUNDV_PUMP.1")}
	},
	[ACT_VM_PRIMARYATTACK_1] = {
		//{ ["time"] = 0.15, ["type"] = "lua", ["value"] = function(wep, vm) wep:EventShell() end, ["client"] = true, ["server"] = true },
		{ ["time"] = .25, type = "sound", value = Sound("TFA_FOUNDV_PUMP.1")}
	},
	[ACT_VM_DRAW] = {															
