...
SWEP.PrintName				= "SAKO TRG-42 10th Anniversary"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 420					-- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Saiko 420 Blaze It"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_trg42gs.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_trg42gs.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_trg42gs")
