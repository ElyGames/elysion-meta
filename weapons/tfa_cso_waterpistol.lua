...
SWEP.PrintName				= "Lightning BIG-EYE"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("BigEye.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 2500					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Burst				= 2500					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Pew Pew Splash"
...
SWEP.DefaultFireMode 	= "5Burst" --Default to auto or whatev
SWEP.FireModes = {"5Burst"}
...
SWEP.Primary.StaticRecoilFactor = 0.001 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.Primary.SpreadRecovery = 0 --How much the spread recovers, per second.
...
SWEP.ChangeStateRecoilMultiplier=1.0  --Multiply recoil by this factor when we're crouching.  This is proportional, not inversely.
...
SWEP.WalkAccuracyMultiplier=1.0--Less is more.  Accuracy * 2 = Half as accurate.  Accuracy * 5 = 1/5 as accurate
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_waterpistol.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_waterpistol.mdl" -- same case UHGI;DFSD/
...
SWEP.Secondary.IronFOV			= 42.5					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(7.039, -2.541, 1.916)
...
SWEP.MuzzleFlashEffect = "cso_muz_wg" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_waterpistol")
	SWEP.DrawWeaponSelection = TFA_CSO_DrawWeaponSelection
end

DEFINE_BASECLASS(SWEP.Base)
function SWEP:Holster( ... )
	self:StopSound("BigEye.Idle")
