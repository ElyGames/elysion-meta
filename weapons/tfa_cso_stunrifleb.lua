...
SWEP.PrintName				= "Stun Rifle (Charging)"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_stunriflec"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stunrifleb.mdl" --Viewmodel path
...
function SWEP:Holster( ... )
	self:StopSound("Stunrifle.IdleB")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stunrifleb")
