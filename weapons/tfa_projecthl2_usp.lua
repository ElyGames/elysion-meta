...
SWEP.Type 				= "9mm Semi-Auto Handgun"
SWEP.Description 		= ""
SWEP.Contact			= "" --Contact Info Tooltip
SWEP.Purpose			= "For The Freeman" --Purpose Tooltip
SWEP.Instructions		= "" --Instructions Tooltip
SWEP.Spawnable			= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable		= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair		= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS	= false --Draw the crosshair in ironsights?
SWEP.PrintName			= "Project HL2 Pistol"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("Project_MMOD_USP.Fire") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/c_IIopnPistol.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_IIopnPistol.mdl" -- Weapon world model path
SWEP.Bodygroups_W = {
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0.039, -18.122, -11.672)
SWEP.RunSightsAng = Vector(70, 0.721, -2.056)
SWEP.SprintBobMult = 0.625
SWEP.SafetyPos = Vector(-0.237, -10.58, -10.325)
SWEP.SafetyAng = Vector(40.426, 0, 0)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.34, -2, 1.6)
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(2.039, -7.628, -1.461)
SWEP.InspectAng = Vector(17.51, 19.267, 0)
...
SWEP.MuzzleFlashEffect = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "mmod_muzzleflash_pistol" or "tfa_muzzleflash_pistol"
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
	    {time = 1 / 30, type = "sound", value = Sound("Project_Generic.Movement5")},
		{time = 28 / 30, type = "sound", value = Sound("Project_Generic.Movement2")},
		{time = 70 / 30, type = "sound", value = Sound("Project_Generic.Movement4")},
