...
SWEP.Manufacturer = "Beretta" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "ARX-160"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.ARX160.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.ARX160.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_arx160.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_arx160.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.566, -4, 0.78)
SWEP.IronSightsAng = Vector(0.344, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.566, -4, 0.845)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-3.566, -4, 0.855)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.566, -4, 0.48)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.566, -5, 0.475)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-3.566, -5, 0.435)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-3.492, -5, 0.985)
...
SWEP.StatusLengthOverride = {
	["base_reload"] = 69 / 30,
	["base_reload_empty"] = 76 / 30,
	["foregrip_reload"] = 69 / 30,
	["foregrip_reload_empty"] = 76 / 30,
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Standard"] = { scale = Vector(1, 1, 1), pos = Vector(4, -0.475, 0.65), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(1, 1, 1), pos = Vector(4, -0.475, 0.65), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_sights_arx160_up.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_sights_arx160_down.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_arx160.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "laser", rel = "laser", pos = Vector(0, 0, 0), angle = Angle(90, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false }
}

SWEP.WElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sights_arx160_up.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sights_arx160_down.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_arx160.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}

SWEP.Attachments = {
	[1] = { atts = { "ins2_br_supp", "ins2_br_heavy" }, order = 1 },
	[3] = { atts = { "am_match", "am_magnum" }, order = 5 },
	[6] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
	[7] = { atts = { "ins2_fg_grip" }, order = 3 },
	[5] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight" }, order = 4 },
}
