...
SWEP.PrintName				= "UTS-15 Expert"		-- Weapon name (Shown on HUD)
SWEP.NZPaPName				= "PBR-30"			-- For nZombies. Pack-a-punch this gun to get this name!
...
--Firing related
SWEP.Primary.Sound 			= Sound("UTS15.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "UnTimely Sacrifice-30"
SWEP.NZPaPReplacement 	= "tfa_cso_uts15_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_uts15_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_uts15_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_uts15_v6")
