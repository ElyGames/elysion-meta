...
SWEP.PrintName				= "CROW-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow1.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(4.53, 0, 0.9)
SWEP.IronSightsAng = Vector(2.338, 0, 0)
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		...
		{ time = 24 / 30, type = "lua", value = function(wep) wep:CrowEnableCheck() end},
		{ time = 30 / 30, type = "lua", value = function(wep) wep:CrowChooseReloadAnim() end},
	},
	[ACT_VM_RELOAD_END] = {
		{ time = 10 / 30, type = "lua", value = function(wep) wep:CrowCompleteReload() end},
	},
	[ACT_VM_RELOAD_END_EMPTY] = {
		{ time = 31 / 30, type = "lua", value = function(wep) wep:CrowCompleteReload() end},
	},
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crow1")
