...
SWEP.ViewModel				= "models/weapons/tfa_v_m98bravo.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_barrett_m98b.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-2.196, -3, 1)
