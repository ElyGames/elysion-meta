...
SWEP.snd,SWEP.snd1,SWEP.explo = "weapons/jetgun_shoot.ogg",Sound("weapons/jetgun_off.ogg"),Sound("weapons/jet_gun_explo_new.ogg")
SWEP.hit1,SWEP.hit2 = Sound("weapons/grind_00.ogg"),Sound("weapons/grind_01.ogg")
...
SWEP.ViewModel			= "models/weapons/jetgun/v_jetgun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/jetgun/w_jetgun.mdl" -- Weapon world model path
