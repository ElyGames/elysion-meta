...
SWEP.PrintName				= "M1887 Maverick"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "After-Market Rocket"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1887_maverick.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1887_maverick.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.889, 0, 0)
SWEP.IronSightsAng = Vector(4.381, -0.35, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1887_maverick")
