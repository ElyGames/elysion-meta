...
SWEP.PrintName				= "KSG-12 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("KSG12.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 67					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 67					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Metallian-24 Expert"
SWEP.NZPaPReplacement 	= "tfa_cso_ksg12_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ksg12_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ksg12_expert.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.064, -9.221, 1.49)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ksg12_expert")
