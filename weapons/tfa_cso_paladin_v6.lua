...
SWEP.PrintName				= "AK-47 Royal Knight"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Spread		= .00585					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .002925	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_paladin_tyrant.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_paladin_tyrant.mdl" -- I couldn't compile the Dark Knight's worldmodel either... why me
...
SWEP.MuzzleFlashEffect = "cso_muz_pal_ty" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_pal_ty" 	--Change to a string of your tracer name.  Can be custom.
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_paladin_v6")
