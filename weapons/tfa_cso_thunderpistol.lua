...
SWEP.Instructions				= "Just shoot at things" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "Thunder Ghost Walker"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Thunder.Shoot")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 250					-- Damage, in standard damage points.
SWEP.Primary.BlastRadius	= 200               -- Radius for DMG_BLAST
...
SWEP.Primary.DefaultClip			= 151				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thunderpistol.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_thunderpistolpaintwood" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_thunderpistol.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_thunderpistol" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "tra_thunderpistol" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Primary.ImpactEffect = "exp_thunderpistol"
--[[EVENT TABLE]]--
...
function SWEP:Holster( ... )
    self:StopSound("Thunder.Loop")
	self:StopSound("Thunder.Idle1")
	self:StopSound("Thunder.Idle2")
	self:StopSound("Thunder.Idle3")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thunderpistol")
