...
SWEP.PrintName				= "Savery Expert"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.625 				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sprifle_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_savery_v6.mdl" -- Worldmodel path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_savery_v6")
