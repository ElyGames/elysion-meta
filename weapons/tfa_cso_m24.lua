...
SWEP.PrintName				= "Remington M24"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M24.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m24.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_m24transgear" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m24.mdl" -- Worldmodel path
...
SWEP.BoltTimerOffset = 0.2 --How long you stay sighted in after shooting, with a bolt action.
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/m24/m24_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(7.236, -6.031, -1.005)
SWEP.IronSightsAng = Vector(30, 20.402, 18.291)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m24")
