...
SWEP.Gun = ("tfa_auga3") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_auga3sa.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_auga3.mdl"	-- Weapon world model
