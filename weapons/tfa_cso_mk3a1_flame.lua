...
SWEP.PrintName				= "MK3A1 Flame"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MK3A1Flame.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mk3a1_flame.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mk3a1_flame.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.519, 0, 1.44)
SWEP.IronSightsAng = Vector(-1.591, 1.422, 1.531)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mk3a1_flame")
