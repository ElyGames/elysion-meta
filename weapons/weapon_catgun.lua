...
sound.Add( { 
  ...
  sound = { 
    "weapons/catgun_fire01.ogg",
    "weapons/catgun_fire02.ogg",
    "weapons/catgun_fire03.ogg",
    "weapons/catgun_fire04.ogg",
    "weapons/catgun_fire05.ogg",
    "weapons/catgun_fire06.ogg",
    "weapons/catgun_fire07.ogg",
    "weapons/catgun_fire08.ogg"
  }
} )
sound.Add( { name = "catgun.catgun_reload", channel = CHAN_ITEM, volume = 0.70, level = SNDLVL_NORM, sound = "weapons/catgun_reload.ogg" } )
sound.Add( { name = "catgun.catgun_reload00", channel = CHAN_ITEM, volume = 0.70, level = SNDLVL_NORM, sound = "weapons/catgun_reload00.ogg" } )
--sound.Add( { name = "catgun.catgun_reload_shorter", channel = CHAN_ITEM, volume = 0.70, level = SNDLVL_NORM, sound = "weapons/catgun_reload_shorter.ogg" } )
--sound.Add( { name = "catgun.catgun_reload00_shorter", channel = CHAN_ITEM, volume = 0.70, level = SNDLVL_NORM, sound = "weapons/catgun_reload00_shorter.ogg" } )
sound.Add( { name = "catgun.catgun_deploy", channel = CHAN_STATIC, volume = 0.70, level = SNDLVL_NORM, sound = "weapons/catgun_deploy.ogg" } )
...
SWEP.PrintName = "*Love* Cat Gun" -- 'Nice' Weapon name (Shown on HUD)
...
SWEP.Primary.Sound = Sound("catgun.catgun_fire") 
