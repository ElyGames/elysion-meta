...
SWEP.PrintName				= "Crossbow Advance"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 64					-- Damage, in standard damage points.
...
SWEP.NZPaPReplacement 	= "tfa_cso_crossbowex_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.KickDown			= 0.015					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crossbowex.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crossbowex.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_crossbowex")
