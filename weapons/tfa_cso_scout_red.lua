...
SWEP.PrintName				= "Steyr Scout Red"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Scout.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "AWP Made in China"
--SWEP.NZPaPReplacement 	= "tfa_cso_scout_red"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.Spread		= .002					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.MoveSpeed = 1.5 --Multiply the player's movespeed by this.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scout_red.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scoutred.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.298, -5.599, 1.108)
SWEP.IronSightsAng = Vector(1.189, -0.144, 1.858)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_scout_red")
