...
SWEP.ViewModel				= "models/weapons/tfa_v_rem870tactical.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_remington_870_tact.mdl"	-- Weapon world model
