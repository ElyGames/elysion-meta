...
SWEP.PrintName				= "AI AS50 Pink Gold"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.DefaultClip			= 88				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_as50g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_as50g.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_as50g")
