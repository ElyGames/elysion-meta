...
SWEP.PrintName				= "Plasma Rifle MK-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PlasmaMK1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPReplacement 	= "tfa_cso_plasmagunexb"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ProjectileEntity = "plasmaexa" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_plasmaexa.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_plasmagunexa.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_plasmagunexa")
