...
SWEP.PrintName				= "AI AS50 Master"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_as50_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_as50_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_as50_master")
