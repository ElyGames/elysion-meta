...
SWEP.Manufacturer = "SDF" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "Volk"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2			-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 73			-- Position in the slot
SWEP.AutoSwitchTo			= true		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= true		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "Energy Assault Rifle"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.VOLK.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Displayed = 500
...
--Ammo Related
SWEP.Primary.ClipSize = 28 -- This is the size of a clip
...
--Recoil Related
SWEP.Primary.KickUp = 0.60 -- This is the maximum upwards recoil (rise)
...
SWEP.Primary.SpreadMultiplierMax = 4.5 --How far the spread can expand when you shoot. Example val: 2.5
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed  * 0.65 --Multiply the player's movespeed by this when sighting.
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_volk.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_volk.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.55, -4, 0.155)
SWEP.IronSightsAng = Vector(-0.1, -0.01, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.54, -2, -0.75)
SWEP.IronSightsAng_Kobra = Vector(0, -0.01, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.54, -2, -0.74)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.54, -2, -0.74)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS =  Vector(-2.538, -2, -0.744)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 =  Vector(-2.539, -2, -0.852)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.485, -2, -0.456)
...
SWEP.StatusLengthOverride = {
	["base_reload"] = 65 / 30,
	["base_reload_empty"] = 65 / 30,
	["foregrip_reload"] = 65 / 30,
	["foregrip_reload_empty"] = 65 / 30,
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(attscale * .5, attscale * .5, attscale * .5), pos = Vector(0, 0, -0.25), angle = Angle(0, 0, 0) },
	["A_Optic"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(attscale, attscale, attscale), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(-4, 0, 0), angle = Angle(0, -90, 0) },
}

SWEP.VElements = {
	["grip_refract"] = { type = "Model", model = "models/weapons/tfa_ins2/c_volk_grip_refract.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_ins.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(3.9, 0.435, 2.095), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
}
...
SWEP.WElements = {
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ins_foregrip.mdl", bone = "ATTACH_Foregrip", rel = "", pos = Vector(1, -0.004, -0.322), angle = Angle(0, 0, 0), size = Vector(0.8,0.8,0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}
SWEP.Attachments = {
...
-- update screenspace texture before drawing refract part
