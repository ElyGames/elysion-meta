...
SWEP.PrintName				= "Violon"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Violingun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Killed By Music"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_violingun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_violingun.mdl" -- Worldmodel path
