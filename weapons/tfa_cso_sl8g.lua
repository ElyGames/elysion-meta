...
SWEP.PrintName				= "SL8 Gold"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SL8.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Gold G36 Sniper Rifle"
...
SWEP.Primary.KickHorizontal			= 0.135					-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.IronAccuracy = .0008	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sl8g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sl8g.mdl" -- Worldmodel path
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/sl8/sl8_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(4.218, -2.116, 1.213)
SWEP.IronSightsAng = Vector(2.678, -0.422, 4.519)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sl8g")
