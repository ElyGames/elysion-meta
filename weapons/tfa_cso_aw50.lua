...
SWEP.PrintName				= "AI AW50F"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("AW50.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.DefaultClip			= 55				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_aw50.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_aw50.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(4.702, -1.609, 1.608)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_aw50")
