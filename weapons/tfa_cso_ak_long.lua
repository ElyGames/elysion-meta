...
SWEP.PrintName				= "AK-47 60R"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Ak47_long.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "USSR Intensified"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47_long.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47_long.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.682, -9.896, 2.388)
SWEP.IronSightsAng = Vector(0, 0, 1.19)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ak_long")
